...
local-out-zip-file := MIUI_x820.zip
...
local-miui-modified-apps-smali := Settings TeleService SecurityCoreAdd XiaomiServiceFramework MiuiSystemUI MiuiKeyguard SecurityCenter
