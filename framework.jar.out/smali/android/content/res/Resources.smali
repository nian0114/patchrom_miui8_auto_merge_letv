...
.method private loadDrawableForCookie(Landroid/util/TypedValue;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
    ...
    :cond_2
    :try_start_1
    iget-object v9, p0, Landroid/content/res/Resources;->applicationInfo:Landroid/content/pm/ApplicationInfo;

    invoke-static {p2, v9, p0}, Landroid/content/res/theme/LeResourceHelper;->getLetvThemeResDrawable(ILandroid/content/pm/ApplicationInfo;Landroid/content/res/Resources;)Landroid/graphics/drawable/Drawable;

    move-result-object v6

    .line 2696
    .local v6, "letvDrawable":Landroid/graphics/drawable/Drawable;
    if-nez v6, :cond_1
    ...
    invoke-virtual {v9, v10, v3, v11}, Landroid/content/res/AssetManager;->openNonAsset(ILjava/lang/String;I)Ljava/io/InputStream;
    ...
    invoke-static {p0, p1, v4, v3, v9}, Landroid/graphics/drawable/Drawable;->createFromResourceStream(Landroid/content/res/Resources;Landroid/util/TypedValue;Ljava/io/InputStream;Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p2, v9, p0}, Landroid/content/res/theme/LeResourceHelper;->isNeedClipIcon(ILandroid/content/pm/ApplicationInfo;Landroid/content/res/Resources;)Z
    ...
    invoke-virtual {p0, p1, v4, v3, p2}, Landroid/content/res/Resources;->createFromResourceStream(Landroid/util/TypedValue;Ljava/io/InputStream;Ljava/lang/String;I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    .local v0, "clipDrawableIcon":Landroid/graphics/drawable/Drawable;
    if-eqz v0, :cond_4
    ...
    .end local v0    # "clipDrawableIcon":Landroid/graphics/drawable/Drawable;
    :cond_4
    invoke-virtual {v4}, Ljava/io/InputStream;->close()V
    :try_end_1
    ...
    .end local v6    # "letvDrawable":Landroid/graphics/drawable/Drawable;
    :catch_0
    move-exception v2
...
.method public getText(I)Ljava/lang/CharSequence;
    ...
    invoke-static {p0, v9, p1}, Landroid/content/res/theme/LeResourceHelper;->getReplaceText(Landroid/content/res/Resources;Landroid/content/pm/ApplicationInfo;I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v9, p1}, Landroid/content/res/AssetManager;->getResourceText(I)Ljava/lang/CharSequence;

    move-result-object v4

    .line 321
    .local v4, "res":Ljava/lang/CharSequence;
    if-eqz v4, :cond_3

    .line 322
    const-string v9, "1"

    const-string/jumbo v10, "sys.display.string"
    ...
    const-string/jumbo v10, "le_status_format1"

    aput-object v10, v2, v9

    const/4 v9, 0x1

    const-string/jumbo v10, "le_status_format2"

    aput-object v10, v2, v9

    const/4 v9, 0x2

    const-string/jumbo v10, "system_ui_date_pattern"

    aput-object v10, v2, v9

    const/4 v9, 0x3

    const-string/jumbo v10, "pattern_month_day"

    aput-object v10, v2, v9

    const/4 v9, 0x4

    const-string/jumbo v10, "pattern_week_complete"

    aput-object v10, v2, v9

    const/4 v9, 0x5

    const-string/jumbo v10, "pattern_group_over_century"

    aput-object v10, v2, v9

    const/4 v9, 0x6

    const-string/jumbo v10, "pattern_group_future"

    aput-object v10, v2, v9

    const/4 v9, 0x7

    const-string/jumbo v10, "le_status_leap"

    aput-object v10, v2, v9

    const/16 v9, 0x8

    const-string/jumbo v10, "le_status_year"

    aput-object v10, v2, v9

    const/16 v9, 0x9

    const-string/jumbo v10, "le_status_month"

    aput-object v10, v2, v9

    const/16 v9, 0xa

    const-string/jumbo v10, "le_status_day"

    aput-object v10, v2, v9

    const/16 v9, 0xb

    const-string/jumbo v10, "le_status_chushi"

    aput-object v10, v2, v9

    const/16 v9, 0xc

    const-string/jumbo v10, "le_status_ershi"

    aput-object v10, v2, v9

    const/16 v9, 0xd

    const-string/jumbo v10, "le_status_sanshi"

    aput-object v10, v2, v9

    .line 325
    .local v2, "noNeedReplaceStr":[Ljava/lang/String;
    ...
    iget-object v10, p0, Landroid/content/res/Resources;->mMetrics:Landroid/util/DisplayMetrics;

    invoke-virtual {p0, v9, v10}, Landroid/content/res/Resources;->updateConfiguration(Landroid/content/res/Configuration;Landroid/util/DisplayMetrics;)V
    ...
    .line 329
    .local v5, "resCH":Ljava/lang/CharSequence;
    iget-object v9, p0, Landroid/content/res/Resources;->mConfiguration:Landroid/content/res/Configuration;
    ...
    .line 332
    .local v8, "resUS":Ljava/lang/CharSequence;
    iget-object v9, p0, Landroid/content/res/Resources;->mConfiguration:Landroid/content/res/Configuration;

    iput-object v3, v9, Landroid/content/res/Configuration;->locale:Ljava/util/Locale;
    ...
    .line 337
    .local v6, "resEntry":Ljava/lang/String;
    if-eqz v7, :cond_0
    ...
    .line 351
    .end local v0    # "i":I
    .end local v2    # "noNeedReplaceStr":[Ljava/lang/String;
    .end local v3    # "oldLocale":Ljava/util/Locale;
    .end local v5    # "resCH":Ljava/lang/CharSequence;
    .end local v6    # "resEntry":Ljava/lang/String;
    .end local v7    # "resType":Ljava/lang/String;
    .end local v8    # "resUS":Ljava/lang/CharSequence;
    :cond_3
    new-instance v9, Landroid/content/res/Resources$NotFoundException;
    ...
    const-string v11, "String resource ID #0x"
...
.method public openRawResource(ILandroid/util/TypedValue;)Ljava/io/InputStream;
    ...
    invoke-static {v3, v4}, Landroid/content/res/theme/LeResourceHelper;->replaceDefaultWallpaper(Ljava/lang/String;Landroid/util/DisplayMetrics;)Ljava/io/FileInputStream;
...
.method public updateConfiguration(Landroid/content/res/Configuration;Landroid/util/DisplayMetrics;Landroid/content/res/CompatibilityInfo;)V
    ...
    .restart local v21    # "themeChange":Z
    :catchall_1
    move-exception v2
