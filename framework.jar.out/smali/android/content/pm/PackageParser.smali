...
.method private parseBaseApk(Landroid/content/res/Resources;Landroid/content/res/XmlResourceParser;I[Ljava/lang/String;)Landroid/content/pm/PackageParser$Package;
    ...
    .local v26, "fi":Landroid/content/pm/FeatureInfo;
    ...
    .end local v26    # "fi":Landroid/content/pm/FeatureInfo;
    :cond_1b
    ...
    new-instance v28, Landroid/content/pm/FeatureGroupInfo;

    invoke-direct/range {v28 .. v28}, Landroid/content/pm/FeatureGroupInfo;-><init>()V

    .local v28, "group":Landroid/content/pm/FeatureGroupInfo;
    const/16 v25, 0x0

    .local v25, "features":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/content/pm/FeatureInfo;>;"
    invoke-interface/range {p2 .. p2}, Landroid/content/res/XmlResourceParser;->getDepth()I
    ...
    .local v24, "featureInfo":Landroid/content/pm/FeatureInfo;
    move-object/from16 v0, v24
    ...
    .end local v24    # "featureInfo":Landroid/content/pm/FeatureInfo;
    :goto_4
    invoke-static/range {p2 .. p2}, Lcom/android/internal/util/XmlUtils;->skipCurrentTag(Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    .end local v25    # "features":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/content/pm/FeatureInfo;>;"
    .end local v28    # "group":Landroid/content/pm/FeatureGroupInfo;
    ...
    .end local v36    # "len$":I
    :goto_b
    const-string v3, "persist.sys.disable.M.perm"

    invoke-static {v3}, Landroid/os/SystemProperties;->get(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v22

    .local v22, "disableRuntimePermission":Ljava/lang/String;
    ...
    .end local v22    # "disableRuntimePermission":Ljava/lang/String;
