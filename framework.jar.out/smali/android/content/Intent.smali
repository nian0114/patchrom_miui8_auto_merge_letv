...
.field public static final ACTION_PHONECONTROL_POWER_LEUI:Ljava/lang/String; = "com.letv.leui.action.PHONE_CONTROL_POWER_STATUS"
...
.field public static final ACTION_VIEW_CONTACT_CALLLOG:Ljava/lang/String; = "android.intent.action.VIEW_CONTACT_CALLLOG"

.field public static final ACTION_VIEW_NUMBER_CALLLOG:Ljava/lang/String; = "android.intent.action.VIEW_NUMBER_CALLLOG"
...
.field public static final EUI_FLAG_IGNORE_CHECK_ACCESS_CONTROL:I = 0x1

.field public static final EUI_FLAG_REUSE_ACCESS_CONTROL_TASK:I = 0x100
...
.field public static final FLAG_ACTIVITY_ON_TOP:I = -0x80000000
...
.field public static final LEUI_CHECK_ACCESSCONTROL:Ljava/lang/String; = "android.intent.extra.android.intent.action.LEUI_CHECK_ACCESSCONTROL"
...
.method public constructor <init>(Landroid/content/Intent;)V
    ...
    iget v0, p1, Landroid/content/Intent;->mEuiFlags:I

    iput v0, p0, Landroid/content/Intent;->mEuiFlags:I
...
.method public addEuiFlags(I)Landroid/content/Intent;
    .locals 1
    .param p1, "flags"    # I

    .prologue
    iget v0, p0, Landroid/content/Intent;->mEuiFlags:I
...
.method public addInnerBgMark()V
    ...
    .prologue
    const-string v0, "com.letv.android.intent.extra.inner_bg_INTENT"
...
.method public fillIn(Landroid/content/Intent;I)I
    ...
    iget v4, p0, Landroid/content/Intent;->mEuiFlags:I

    iget v5, p1, Landroid/content/Intent;->mEuiFlags:I

    or-int/2addr v4, v5

    iput v4, p0, Landroid/content/Intent;->mEuiFlags:I
...
.method public getCallingUid()I
    ...
    .prologue
    iget v0, p0, Landroid/content/Intent;->mCallingUid:I
...
.method public readFromParcel(Landroid/os/Parcel;)V
    ...
    iput v2, p0, Landroid/content/Intent;->mEuiFlags:I

    invoke-virtual {p1}, Landroid/os/Parcel;->readInt()I

    move-result v2

    iput v2, p0, Landroid/content/Intent;->mCallingUid:I
...
.method public setCallingUid(I)Landroid/content/Intent;
    .locals 0
    .param p1, "callingUid"    # I

    .prologue
    iput p1, p0, Landroid/content/Intent;->mCallingUid:I
...
.method public setEuiFlags(I)Landroid/content/Intent;
    .locals 0
    .param p1, "flags"    # I

    .prologue
    iput p1, p0, Landroid/content/Intent;->mEuiFlags:I
...
.method public toShortString(Ljava/lang/StringBuilder;ZZZZ)V
    ...
    const-string v0, "Euiflg=0x"

    invoke-virtual {p1, v0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    iget v1, p0, Landroid/content/Intent;->mEuiFlags:I
    ...
    iget v1, p0, Landroid/content/Intent;->mCallingUid:I
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    iget v2, p0, Landroid/content/Intent;->mEuiFlags:I

    invoke-virtual {p1, v2}, Landroid/os/Parcel;->writeInt(I)V

    iget v2, p0, Landroid/content/Intent;->mCallingUid:I
