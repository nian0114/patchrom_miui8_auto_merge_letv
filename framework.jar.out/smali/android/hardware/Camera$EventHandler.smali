...
.method public handleMessage(Landroid/os/Message;)V
    ...
    # getter for: Landroid/hardware/Camera;->mPanoListener:Landroid/hardware/Camera$PanoListener;
    invoke-static {v5}, Landroid/hardware/Camera;->access$1700(Landroid/hardware/Camera;)Landroid/hardware/Camera$PanoListener;
    ...
    invoke-interface {v6, v5, v7}, Landroid/hardware/Camera$PanoListener;->onPanoProcess([BLandroid/hardware/Camera;)V
    ...
    # getter for: Landroid/hardware/Camera;->mASDListener:Landroid/hardware/Camera$ASDListener;
    invoke-static {v5}, Landroid/hardware/Camera;->access$1800(Landroid/hardware/Camera;)Landroid/hardware/Camera$ASDListener;
    ...
    invoke-interface {v6, v5, v7}, Landroid/hardware/Camera$ASDListener;->onASDDetect([BLandroid/hardware/Camera;)V
    ...
    # invokes: Landroid/hardware/Camera;->handleLetvDualCamMsg(Landroid/os/Message;)V
    invoke-static {v5, p1}, Landroid/hardware/Camera;->access$1900(Landroid/hardware/Camera;Landroid/os/Message;)V
