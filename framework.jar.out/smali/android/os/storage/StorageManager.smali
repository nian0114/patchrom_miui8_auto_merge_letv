...
.method private checkNameIsValid(Ljava/lang/String;)Z
    .locals 3
    ...
    const-string v2, "   StorageManager.checkNameIsValid  INVALID NAME: "
...
# virtual methods
.method public addPrivateFolder([Ljava/lang/String;[Ljava/lang/String;)V
    .locals 1
    .param p1, "appList"    # [Ljava/lang/String;
    .param p2, "folderList"    # [Ljava/lang/String;
    ...
    invoke-virtual {p0, p1, p2, v0}, Landroid/os/storage/StorageManager;->setPrivateFolder([Ljava/lang/String;[Ljava/lang/String;I)V
...
.method public removePrivateFolder([Ljava/lang/String;)V
    .locals 2
    .param p1, "appList"    # [Ljava/lang/String;
    ...
    invoke-virtual {p0, p1, v0, v1}, Landroid/os/storage/StorageManager;->setPrivateFolder([Ljava/lang/String;[Ljava/lang/String;I)V

    goto :goto_0
.end method

.method public removePrivateFolder([Ljava/lang/String;[Ljava/lang/String;)V
    .locals 1
    .param p1, "appList"    # [Ljava/lang/String;
    .param p2, "folderList"    # [Ljava/lang/String;
...
.method public removePrivateFolderAll()V
    .locals 2
    ...
    invoke-virtual {p0, v1, v1, v0}, Landroid/os/storage/StorageManager;->setPrivateFolder([Ljava/lang/String;[Ljava/lang/String;I)V
...
.method public setPrivateFolder([Ljava/lang/String;[Ljava/lang/String;I)V
    .locals 7
    .param p1, "appList"    # [Ljava/lang/String;
    .param p2, "folderList"    # [Ljava/lang/String;
    .param p3, "flag"    # I
    ...
    const-string/jumbo v6, "setPrivateFolder  callingApp="
    ...
    .line 706
    .local v3, "rawBuilder":Ljava/lang/StringBuilder;
    const/4 v4, 0x1
    ...
    const-string/jumbo v5, "setPrivateFolder  ADD private folder "
    ...
    const-string/jumbo v5, "setPrivateFolder  Illegal Argument appList.length!=folderList.length"
    ...
    const-string/jumbo v5, "setPrivateFolder  Illegal Argument appList.length==0"
    ...
    .line 747
    .end local v3    # "rawBuilder":Ljava/lang/StringBuilder;
    :catch_0
    move-exception v1
    ...
    .line 716
    .end local v1    # "e":Landroid/os/RemoteException;
    .restart local v3    # "rawBuilder":Ljava/lang/StringBuilder;
    :cond_2
    const/4 v2, 0x0
    ...
    invoke-direct {p0, v4}, Landroid/os/storage/StorageManager;->checkNameIsValid(Ljava/lang/String;)Z
    ...
    const-string/jumbo v5, "setPrivateFolder name is invalid  "
    ...
    const-string/jumbo v5, "setPrivateFolder  remove private folder"
    ...
    const-string/jumbo v6, "setPrivateFolder  appListBuilder="
    ...
    invoke-interface {v4, v5, p3}, Landroid/os/storage/IMountService;->setPrivateFolder(Ljava/lang/String;I)V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
