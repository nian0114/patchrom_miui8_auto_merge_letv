...
.method private performTraversals()V
    ...
    .line 1444
    .local v64, "params":Landroid/view/WindowManager$LayoutParams;
    move-object/from16 v0, p0
    ...
    check-cast v57, Lcom/letv/leui/widget/text/clipboard/LeClipboardManager;

    .line 1520
    .local v57, "manager":Lcom/letv/leui/widget/text/clipboard/LeClipboardManager;
    invoke-virtual/range {v57 .. v57}, Lcom/letv/leui/widget/text/clipboard/LeClipboardManager;->isLeClipboardShowing()Z

    move-result v4

    if-eqz v4, :cond_a

    invoke-virtual/range {v57 .. v57}, Lcom/letv/leui/widget/text/clipboard/LeClipboardManager;->getRootView()Landroid/view/View;
    ...
    invoke-virtual {v0, v4, v1}, Lcom/letv/leui/widget/text/clipboard/LeClipboardManager;->onWindowVisibility(Landroid/content/Context;I)V
    ...
    .line 1537
    .end local v57    # "manager":Lcom/letv/leui/widget/text/clipboard/LeClipboardManager;
    :cond_d
    move-object/from16 v0, p0
    ...
    .end local v64    # "params":Landroid/view/WindowManager$LayoutParams;
    ...
    .restart local v64    # "params":Landroid/view/WindowManager$LayoutParams;
    ...
    .line 1480
    .local v63, "packageMetrics":Landroid/util/DisplayMetrics;
    ...
    .end local v8    # "desiredWindowWidth":I
    .end local v9    # "desiredWindowHeight":I
    .end local v63    # "packageMetrics":Landroid/util/DisplayMetrics;
    :cond_1a
    ...
    .line 1592
    .restart local v63    # "packageMetrics":Landroid/util/DisplayMetrics;
    move-object/from16 v0, v63
    ...
    .line 1773
    .local v62, "overscanInsetsChanged":Z
    :goto_e
    move-object/from16 v0, p0
    ...
    .line 1960
    .end local v61    # "outsetsChanged":Z
    .end local v62    # "overscanInsetsChanged":Z
    ...
    .line 1773
    .restart local v62    # "overscanInsetsChanged":Z
    :cond_58
    const/16 v34, 0x0
    ...
    .line 1916
    .restart local v61    # "outsetsChanged":Z
    :catch_0
    move-exception v38
    ...
    invoke-virtual {v0, v4}, Landroid/view/View;->getRectInWindow(Landroid/graphics/Rect;)V
    ...
    .restart local v59    # "needSetBlur":Z
    :cond_9f
    const-string v4, "ViewRootImpl"
...
.method dispatchDetachedFromWindow()V
    ...
    .line 3416
    .local v0, "manager":Lcom/letv/leui/widget/text/clipboard/LeClipboardManager;
    invoke-virtual {v0}, Lcom/letv/leui/widget/text/clipboard/LeClipboardManager;->isLeClipboardShowing()Z

    move-result v1

    if-eqz v1, :cond_1

    invoke-virtual {v0}, Lcom/letv/leui/widget/text/clipboard/LeClipboardManager;->getRootView()Landroid/view/View;
    ...
    invoke-virtual {v0, v1}, Lcom/letv/leui/widget/text/clipboard/LeClipboardManager;->hideLeClipboard(Landroid/content/Context;)V
...
.method doProcessInputEvents()V
    ...
    .line 6398
    iget-object v3, v6, Landroid/view/ViewRootImpl$QueuedInputEvent;->mEvent:Landroid/view/InputEvent;
    ...
    .line 6400
    invoke-virtual {v3, v11}, Landroid/view/MotionEvent;->getHistoricalEventTimeNano(I)J

    move-result-wide v4

    .line 6403
    .end local v3    # "me":Landroid/view/MotionEvent;
    :cond_1
    ...
    invoke-virtual {v7, v0, v1, v4, v5}, Landroid/view/FrameInfo;->updateInputEventTime(JJ)V
    ...
    .line 6405
    const-string v7, "3 1: Process input event"
    ...
    const-string v8, "leclipboard"

    invoke-virtual {v7, v8}, Landroid/content/Context;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Lcom/letv/leui/widget/text/clipboard/LeClipboardManager;

    .line 6411
    .local v2, "manager":Lcom/letv/leui/widget/text/clipboard/LeClipboardManager;
    invoke-virtual {v2}, Lcom/letv/leui/widget/text/clipboard/LeClipboardManager;->isLeClipboardShowing()Z
    ...
    invoke-virtual {v2, v7}, Lcom/letv/leui/widget/text/clipboard/LeClipboardManager;->hideLeClipboard(Landroid/content/Context;)V

    .line 6419
    .end local v2    # "manager":Lcom/letv/leui/widget/text/clipboard/LeClipboardManager;
    :cond_2
    :goto_1
    iget-boolean v7, p0, Landroid/view/ViewRootImpl;->DEBUG_INPUT:Z

    if-nez v7, :cond_3

    iget-boolean v7, p0, Landroid/view/ViewRootImpl;->DEBUG_KEY:Z

    if-nez v7, :cond_3

    iget-boolean v7, p0, Landroid/view/ViewRootImpl;->DEBUG_MOTION:Z
    ...
    const-string v9, "doProcessInputEvents: mCurrentInputEvent = "
