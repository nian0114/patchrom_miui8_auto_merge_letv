...
.method private static createInterpolatorFromXml(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;)Landroid/view/animation/Interpolator;
    ...
    new-instance v2, Lcom/letv/leui/animation/LeAccelerateDecelerateDampingInterpolator;

    .end local v2    # "interpolator":Landroid/view/animation/BaseInterpolator;
    invoke-direct {v2, p0, p1, v0}, Lcom/letv/leui/animation/LeAccelerateDecelerateDampingInterpolator;-><init>(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;)V
    ...
    :cond_d
    const-string v5, "leBounceInterpolator"
    ...
    new-instance v2, Lcom/letv/leui/animation/LeBounceInterpolator;

    .end local v2    # "interpolator":Landroid/view/animation/BaseInterpolator;
    invoke-direct {v2, p0, p1, v0}, Lcom/letv/leui/animation/LeBounceInterpolator;-><init>(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;)V

    goto :goto_1

    .restart local v2    # "interpolator":Landroid/view/animation/BaseInterpolator;
    :cond_e
    const-string v5, "leDampingInterpolator"
    ...
    new-instance v2, Lcom/letv/leui/animation/LeDampingInterpolator;

    .end local v2    # "interpolator":Landroid/view/animation/BaseInterpolator;
    invoke-direct {v2, p0, p1, v0}, Lcom/letv/leui/animation/LeDampingInterpolator;-><init>(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;)V

    goto :goto_1

    .restart local v2    # "interpolator":Landroid/view/animation/BaseInterpolator;
    :cond_f
    const-string v5, "leUShapeInterpolator"
    ...
    new-instance v2, Lcom/letv/leui/animation/LeUShapeInterpolator;

    .end local v2    # "interpolator":Landroid/view/animation/BaseInterpolator;
    invoke-direct {v2}, Lcom/letv/leui/animation/LeUShapeInterpolator;-><init>()V
