...
.method public getDefaultActivityIcon()Landroid/graphics/drawable/Drawable;
    ...
    const-string v5, "default_icon"

    invoke-direct {v4, v5, v6}, Landroid/app/ApplicationPackageManager$ResourceName;-><init>(Ljava/lang/String;I)V

    .line 923
    .local v4, "name":Landroid/app/ApplicationPackageManager$ResourceName;
    invoke-direct {p0, v4}, Landroid/app/ApplicationPackageManager;->getDefaultCachedIcon(Landroid/app/ApplicationPackageManager$ResourceName;)Landroid/graphics/drawable/Drawable;
    ...
    .line 929
    .local v1, "defDr":Landroid/graphics/drawable/Drawable;
    if-eqz v1, :cond_1

    .line 930
    invoke-direct {p0, v4, v1}, Landroid/app/ApplicationPackageManager;->putDefaultCachedIcon(Landroid/app/ApplicationPackageManager$ResourceName;Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-static {v1, v5}, Landroid/content/res/theme/LeIconCustomHelper;->getClipDrawable(Landroid/graphics/drawable/Drawable;Landroid/content/res/Resources;)Landroid/graphics/drawable/Drawable;
    ...
    .line 939
    invoke-direct {p0, v4, v2}, Landroid/app/ApplicationPackageManager;->putDefaultCachedIcon(Landroid/app/ApplicationPackageManager$ResourceName;Landroid/graphics/drawable/Drawable;)V
...
.method public getDrawable(Ljava/lang/String;ILandroid/content/pm/ApplicationInfo;)Landroid/graphics/drawable/Drawable;
    ...
    .line 889
    .end local v1    # "cachedIcon":Landroid/graphics/drawable/Drawable;
    :goto_0
    return-object v1

    .line 829
    .restart local v1    # "cachedIcon":Landroid/graphics/drawable/Drawable;
    :cond_0
    if-nez p3, :cond_1
    ...
    invoke-virtual {v7, p2, v9}, Landroid/content/res/Resources;->getDrawable(ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
    ...
    .line 845
    .local v3, "drClip":Landroid/graphics/drawable/Drawable;
    if-eqz v0, :cond_2
    ...
    invoke-static {v9}, Landroid/content/res/theme/LeIconCustomHelper;->haveThemeTemplateFile(Landroid/content/res/Resources;)Z

    move-result v5

    .line 847
    .local v5, "haveThemplateRes":Z
    if-eqz v5, :cond_2
    ...
    invoke-static {v2, v9}, Landroid/content/res/theme/LeIconCustomHelper;->getClipDrawable(Landroid/graphics/drawable/Drawable;Landroid/content/res/Resources;)Landroid/graphics/drawable/Drawable;
    ...
    .line 850
    invoke-direct {p0, v6, v3}, Landroid/app/ApplicationPackageManager;->putCachedIcon(Landroid/app/ApplicationPackageManager$ResourceName;Landroid/graphics/drawable/Drawable;)V

    .line 854
    .end local v5    # "haveThemplateRes":Z
    :cond_2
    if-nez v3, :cond_3
    ...
    .line 855
    invoke-direct {p0, v6, v2}, Landroid/app/ApplicationPackageManager;->putCachedIcon(Landroid/app/ApplicationPackageManager$ResourceName;Landroid/graphics/drawable/Drawable;)V
    :try_end_1
    ...
    .end local v3    # "drClip":Landroid/graphics/drawable/Drawable;
...
.method public getInstallingPackageState(Ljava/lang/String;)Z
    .locals 5
    .param p1, "PackageName"    # Ljava/lang/String;
    ...
    .line 2710
    .local v1, "installingState":Z
    :try_start_0
    iget-object v2, p0, Landroid/app/ApplicationPackageManager;->mPM:Landroid/content/pm/IPackageManager;

    invoke-interface {v2, p1}, Landroid/content/pm/IPackageManager;->getInstallingPackageState(Ljava/lang/String;)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v4, "get Installing Package State failed "
...
.method public loadUnbadgedItemIcon(Landroid/content/pm/PackageItemInfo;Landroid/content/pm/ApplicationInfo;)Landroid/graphics/drawable/Drawable;
    ...
    instance-of v12, v0, Landroid/content/pm/ActivityInfo;
    ...
    invoke-direct {v9, v12, v13}, Landroid/app/ApplicationPackageManager$ResourceName;-><init>(Ljava/lang/String;I)V

    .line 2263
    .local v9, "name":Landroid/app/ApplicationPackageManager$ResourceName;
    invoke-direct {p0, v9}, Landroid/app/ApplicationPackageManager;->getCachedIcon(Landroid/app/ApplicationPackageManager$ResourceName;)Landroid/graphics/drawable/Drawable;

    move-result-object v3

    .line 2264
    .local v3, "cacheIcon":Landroid/graphics/drawable/Drawable;
    if-nez v3, :cond_0

    .line 2267
    invoke-direct {p0, v1}, Landroid/app/ApplicationPackageManager;->getThemeDrawable(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;

    move-result-object v8

    .line 2268
    .local v8, "letvDrawable":Landroid/graphics/drawable/Drawable;
    if-eqz v8, :cond_3

    .line 2269
    invoke-direct {p0, v9, v8}, Landroid/app/ApplicationPackageManager;->putCachedIcon(Landroid/app/ApplicationPackageManager$ResourceName;Landroid/graphics/drawable/Drawable;)V
    ...
    .end local v3    # "cacheIcon":Landroid/graphics/drawable/Drawable;
    .end local v8    # "letvDrawable":Landroid/graphics/drawable/Drawable;
    .end local v9    # "name":Landroid/app/ApplicationPackageManager$ResourceName;
    :cond_3
    move-object/from16 v0, p1
    ...
    .line 2284
    .local v11, "wlanIcon":Ljava/lang/String;
    if-eqz p1, :cond_6

    move-object/from16 v0, p1

    instance-of v12, v0, Landroid/content/pm/ApplicationInfo;
    ...
    const-string v13, "getDrawable create wlan icon"
    ...
    invoke-static {v12, v11}, Landroid/content/res/theme/LeIconCustomHelper;->getCurrentPackageIcon(Landroid/content/Context;Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    invoke-direct {v4, v10, v2}, Landroid/graphics/drawable/BitmapDrawable;-><init>(Landroid/content/res/Resources;Landroid/graphics/Bitmap;)V
    :try_end_0
    ...
    const-string v13, "getDrawable LeIconCustomHelper create wlan icon"
    ...
    .end local v11    # "wlanIcon":Ljava/lang/String;
    :cond_4
    :goto_3
    move-object v3, v4
    ...
    .restart local v11    # "wlanIcon":Ljava/lang/String;
    :cond_5
    :try_start_2
    const-string v12, "ApplicationPackageManager"

    const-string v13, "getDrawable LeIconCustomHelper no wlan icon"
    ...
    const-string v14, "getDrawable LeIconCustomHelper icon Exception"
