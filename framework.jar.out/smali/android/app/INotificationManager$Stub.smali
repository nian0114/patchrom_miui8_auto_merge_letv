...
.field static final TRANSACTION_getNotificationHeadsUpEnable:I = 0x38

.field static final TRANSACTION_getNotificationHeadsUpEnableMap:I = 0x39

.field static final TRANSACTION_getNotificationOnKeyguardEnable:I = 0x35

.field static final TRANSACTION_getNotificationOnKeyguardEnableMap:I = 0x36

.field static final TRANSACTION_getNotificationPolicy:I = 0x26

.field static final TRANSACTION_getNotificationSubscript:I = 0x2f

.field static final TRANSACTION_getNotificationSubscriptEnable:I = 0x32

.field static final TRANSACTION_getNotificationSubscriptEnableMap:I = 0x33

.field static final TRANSACTION_getNotificationSubscriptMap:I = 0x30
...
.field static final TRANSACTION_setNotificationHeadsUpEnable:I = 0x37

.field static final TRANSACTION_setNotificationOnKeyguardEnable:I = 0x34
...
.field static final TRANSACTION_setNotificationSubscript:I = 0x2e

.field static final TRANSACTION_setNotificationSubscriptEnable:I = 0x31
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .restart local v2    # "_arg1":I
    invoke-virtual {p0, v1, v2}, Landroid/app/INotificationManager$Stub;->setNotificationSubscript(Ljava/lang/String;I)Z
    ...
    .restart local v1    # "_arg0":Ljava/lang/String;
    invoke-virtual {p0, v1}, Landroid/app/INotificationManager$Stub;->getNotificationSubscript(Ljava/lang/String;)I
    ...
    invoke-virtual {p0}, Landroid/app/INotificationManager$Stub;->getNotificationSubscriptMap()Ljava/util/Map;
    ...
    .local v2, "_arg1":Z
    :goto_a
    invoke-virtual {p0, v1, v2}, Landroid/app/INotificationManager$Stub;->setNotificationSubscriptEnable(Ljava/lang/String;Z)V
    ...
    :goto_b
    invoke-virtual {p0, v1, v2}, Landroid/app/INotificationManager$Stub;->getNotificationSubscriptEnable(Ljava/lang/String;Z)Z
    ...
    invoke-virtual {p0}, Landroid/app/INotificationManager$Stub;->getNotificationSubscriptEnableMap()Ljava/util/Map;
    ...
    .restart local v2    # "_arg1":Z
    :goto_c
    invoke-virtual {p0, v1, v2}, Landroid/app/INotificationManager$Stub;->setNotificationOnKeyguardEnable(Ljava/lang/String;Z)V
    ...
    .restart local v2    # "_arg1":Z
    :goto_d
    invoke-virtual {p0, v1, v2}, Landroid/app/INotificationManager$Stub;->getNotificationOnKeyguardEnable(Ljava/lang/String;Z)Z
    ...
    invoke-virtual {p0}, Landroid/app/INotificationManager$Stub;->getNotificationOnKeyguardEnableMap()Ljava/util/Map;
    ...
    .restart local v2    # "_arg1":Z
    :goto_e
    invoke-virtual {p0, v1, v2}, Landroid/app/INotificationManager$Stub;->setNotificationHeadsUpEnable(Ljava/lang/String;Z)V
    ...
    .restart local v2    # "_arg1":Z
    :goto_f
    invoke-virtual {p0, v1, v2}, Landroid/app/INotificationManager$Stub;->getNotificationHeadsUpEnable(Ljava/lang/String;Z)Z
    ...
    invoke-virtual {p0}, Landroid/app/INotificationManager$Stub;->getNotificationHeadsUpEnableMap()Ljava/util/Map;
