...
.field public static final START_TRACEVIEW_MSG:I = 0x97
...
# instance fields
.field private TRACEVIEW_CUR_FILE:Ljava/lang/String;
...
.method constructor <init>()V
    ...
    .line 5667
    iput-object v1, p0, Landroid/app/ActivityThread;->TRACEVIEW_CUR_FILE:Ljava/lang/String;
...
.method private SendMsgForSystemHprof(Ljava/lang/String;)V
    .locals 8
    ...
    invoke-virtual {v1, v6}, Landroid/app/ActivityThread$H;->obtainMessage(I)Landroid/os/Message;
    ...
    invoke-virtual {v1, v0, v4, v5}, Landroid/app/ActivityThread$H;->sendMessageAtTime(Landroid/os/Message;J)Z

    .line 5701
    return-void
.end method

.method static synthetic access$1000(Landroid/app/ActivityThread;ZLjava/lang/String;)V
    .locals 0
...
.method static synthetic access$2800(Landroid/app/ActivityThread;Landroid/app/ActivityThread$CreateBackupAgentData;)V
    .locals 0
    .param p0, "x0"    # Landroid/app/ActivityThread;
    .param p1, "x1"    # Landroid/app/ActivityThread$CreateBackupAgentData;
...
.method static synthetic access$3100(Landroid/app/ActivityThread;Landroid/os/IBinder;ZZ)V
    .locals 0
    .param p0, "x0"    # Landroid/app/ActivityThread;
    .param p1, "x1"    # Landroid/os/IBinder;
    .param p2, "x2"    # Z
...
.method static synthetic access$3500(Landroid/app/ActivityThread;Landroid/os/Message;)V
    .locals 0
    .param p0, "x0"    # Landroid/app/ActivityThread;
    ...
    .prologue
    .line 154
    invoke-direct {p0, p1}, Landroid/app/ActivityThread;->processTraceViewMsg(Landroid/os/Message;)V
...
.method static synthetic access$700(Landroid/app/ActivityThread;ILjava/lang/Object;I)V
    .locals 0
    .param p0, "x0"    # Landroid/app/ActivityThread;
    .param p1, "x1"    # I
    .param p2, "x2"    # Ljava/lang/Object;
...
.method private autoCatchTraceView(ILjava/lang/String;)V
    .locals 9
    .param p1, "timeout"    # I
    ...
    invoke-virtual {v6, v8}, Landroid/app/ActivityThread$H;->obtainMessage(I)Landroid/os/Message;
    ...
    invoke-virtual {v6, v0, v4, v5}, Landroid/app/ActivityThread$H;->sendMessageAtTime(Landroid/os/Message;J)Z
    ...
    invoke-virtual {v6, v1, v4, v5}, Landroid/app/ActivityThread$H;->sendMessageAtTime(Landroid/os/Message;J)Z
...
.method private checkReasonFlags(Landroid/app/ActivityThread$ActivityClientRecord;)V
    ...
    const-string v5, "ActivityThreadEui"

    new-instance v6, Ljava/lang/StringBuilder;

    invoke-direct {v6}, Ljava/lang/StringBuilder;-><init>()V

    const-string v7, "check reason flags for activity window ="
...
.method private clearWindowFlags(Landroid/app/ActivityThread$ActivityClientRecord;)V
    ...
    const-string v7, "clear window flag(FLAG_SHOW_WHEN_LOCKED)for activity window ="
...
.method private closeDebugTraceView(Landroid/os/Message;)V
    .locals 3
    .param p1, "msg"    # Landroid/os/Message;

    .prologue
    .line 5729
    iget-object v0, p0, Landroid/app/ActivityThread;->TRACEVIEW_CUR_FILE:Ljava/lang/String;
    ...
    const-string v1, "do not catch traceView, pls open debug traceView first !!!"
    ...
    iput-object v0, p0, Landroid/app/ActivityThread;->TRACEVIEW_CUR_FILE:Ljava/lang/String;
    ...
    const-string/jumbo v2, "stop catch traceView !! saving :"

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-object v2, p0, Landroid/app/ActivityThread;->TRACEVIEW_CUR_FILE:Ljava/lang/String;
...
.method private deliverNewIntents(Landroid/app/ActivityThread$ActivityClientRecord;Ljava/util/List;)V
    ...
    :cond_0
    const-string v4, "ActivityThreadEui"

    new-instance v5, Ljava/lang/StringBuilder;

    invoke-direct {v5}, Ljava/lang/StringBuilder;-><init>()V

    const-string v6, "deliverNewIntents resonFlags="
...
.method private dumpCurProcessHprof(Landroid/os/Message;)V
    .locals 8
    .param p1, "msg"    # Landroid/os/Message;
    ...
    .line 5707
    .local v3, "flagArray":[Ljava/lang/String;
    const/4 v5, 0x1
    ...
    const-string v7, "end dumpHrpofData!!! save path = "
    ...
    .end local v3    # "flagArray":[Ljava/lang/String;
    ...
    const-string v7, "dumpHrpofData  error!"
...
.method private enableActivityThreadLog(ZLjava/lang/String;)V
    ...
    const-string v6, "enableActivityThreadLog: enable = "
    ...
    .line 5610
    :cond_1
    invoke-direct {p0, p1, p2}, Landroid/app/ActivityThread;->isHandleCurMessage(ZLjava/lang/String;)Z
...
.method static freeHardwareCacheIfNeeded(I)V
    .locals 3
    ...
    const-string v2, "Cleared Hardware Caches"
...
.method private handleLaunchActivity(Landroid/app/ActivityThread$ActivityClientRecord;Landroid/content/Intent;)V
    ...
    .line 2525
    :cond_1
    const-string v0, "ActivityThreadEui"
    ...
    const-string v3, " startsNotResumed="
    ...
    .line 2534
    iget-object v8, p1, Landroid/app/ActivityThread$ActivityClientRecord;->state:Landroid/os/Bundle;

    .line 2535
    .local v8, "oldState":Landroid/os/Bundle;
    ...
    .line 2559
    iput-object v8, p1, Landroid/app/ActivityThread$ActivityClientRecord;->state:Landroid/os/Bundle;
    ...
    invoke-virtual {v0, v1, v7}, Landroid/app/Instrumentation;->onException(Ljava/lang/Object;Ljava/lang/Throwable;)Z
    ...
    .line 2590
    .end local v8    # "oldState":Landroid/os/Bundle;
    :cond_5
    :goto_1
    return-void
...
.method private handleRelaunchActivity(Landroid/app/ActivityThread$ActivityClientRecord;)V
    ...
    .line 4184
    :cond_c
    const-string v7, "ActivityThreadEui"
...
.method private handleSleeping(Landroid/os/IBinder;ZZ)V
    ...
    .line 3750
    .local v1, "r":Landroid/app/ActivityThread$ActivityClientRecord;
    const-string v2, "ActivityThreadEui"

    new-instance v3, Ljava/lang/StringBuilder;

    invoke-direct {v3}, Ljava/lang/StringBuilder;-><init>()V

    const-string v4, "handleSleeping sleeping="
    ...
    .line 3777
    :cond_4
    iget v2, v1, Landroid/app/ActivityThread$ActivityClientRecord;->reasonFlags:I
    ...
    const-string v4, "clear window flag for activity window "
    ...
    const-string v4, " because activity sleeping and screen off"
    ...
    .line 3783
    invoke-direct {p0, v1}, Landroid/app/ActivityThread;->clearWindowFlags(Landroid/app/ActivityThread$ActivityClientRecord;)V
...
.method private handleWindowVisibility(Landroid/os/IBinder;Z)V
    ...
    .line 3741
    const-string v1, "ActivityThreadEui"

    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    const-string v3, "Handle window "
...
.method private isHandleCurMessage(ZLjava/lang/String;)Z
    .locals 5
    .param p1, "enable"    # Z
    .param p2, "flags"    # Ljava/lang/String;
    ...
    const-string v4, "enable autoCatchTraceView catch 20*1000 ms , sava path:"
    ...
    invoke-direct {p0, v2, p2}, Landroid/app/ActivityThread;->autoCatchTraceView(ILjava/lang/String;)V
    ...
    const-string/jumbo v4, "open_hprof"
    ...
    const-string v4, "enable auto dump Hprof , sava path:"
    ...
    .line 5677
    invoke-direct {p0, p2}, Landroid/app/ActivityThread;->SendMsgForSystemHprof(Ljava/lang/String;)V
...
.method private openDebugTraceView(Landroid/os/Message;)V
    .locals 6
    .param p1, "msg"    # Landroid/os/Message;

    .prologue
    .line 5716
    iget-object v3, p0, Landroid/app/ActivityThread;->TRACEVIEW_CUR_FILE:Ljava/lang/String;
    ...
    const-string/jumbo v4, "has catching traceView, pls close debug traceView first!"
    ...
    iput-object v2, p0, Landroid/app/ActivityThread;->TRACEVIEW_CUR_FILE:Ljava/lang/String;
    ...
    const-string/jumbo v5, "starting catch traceView !!! tr file:"

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget-object v5, p0, Landroid/app/ActivityThread;->TRACEVIEW_CUR_FILE:Ljava/lang/String;
    ...
    invoke-static {v3, v4, v5}, Landroid/os/Debug;->startMethodTracingSamplingEx(Ljava/lang/String;II)V
...
.method private performStopActivityInner(Landroid/app/ActivityThread$ActivityClientRecord;Landroid/app/ActivityThread$StopInfo;ZZ)V
    ...
    .line 3630
    :cond_6
    iget v1, p1, Landroid/app/ActivityThread$ActivityClientRecord;->reasonFlags:I
    ...
    const-string v3, "clear window flag for activty window "
    ...
    const-string v3, " because activity stopped"
...
.method private processTraceViewMsg(Landroid/os/Message;)V
    .locals 2
    .param p1, "msg"    # Landroid/os/Message;
    ...
    .line 5685
    invoke-direct {p0, p1}, Landroid/app/ActivityThread;->openDebugTraceView(Landroid/os/Message;)V
    ...
    .line 5687
    invoke-direct {p0, p1}, Landroid/app/ActivityThread;->closeDebugTraceView(Landroid/os/Message;)V
    ...
    .line 5689
    invoke-direct {p0, p1}, Landroid/app/ActivityThread;->dumpCurProcessHprof(Landroid/os/Message;)V
...
.method private updateVisibility(Landroid/app/ActivityThread$ActivityClientRecord;Z)V
    ...
    const-string v3, " is NOT going to show a UI(makeVisible)"
...
.method final handleActivityConfigurationChanged(Landroid/app/ActivityThread$ActivityConfigChangeData;)V
    ...
    iput v4, v1, Landroid/content/res/Configuration;->leFontScale:F
...
.method final handleConfigurationChanged(Landroid/content/res/Configuration;Landroid/content/res/CompatibilityInfo;)V
    ...
    iget v4, p1, Landroid/content/res/Configuration;->leGlobalFont:I

    if-lez v4, :cond_7

    .line 4395
    invoke-static {v2}, Landroid/app/ActivityThread;->freeHardwareCacheIfNeeded(I)V
...
.method final handleResumeActivity(Landroid/os/IBinder;ZZIZ)V
    ...
    iput p4, v4, Landroid/app/ActivityThread$ActivityClientRecord;->reasonFlags:I
    ...
    :cond_1
    :goto_2
    invoke-direct {p0, v4}, Landroid/app/ActivityThread;->checkReasonFlags(Landroid/app/ActivityThread$ActivityClientRecord;)V
    ...
    .line 3278
    iget-object v7, v4, Landroid/app/ActivityThread$ActivityClientRecord;->intent:Landroid/content/Intent;
    ...
    const-string v9, " is NOT going to show a UI(addView)"
    ...
    const-string v9, " is NOT going to show a UI (makeVisible)"
