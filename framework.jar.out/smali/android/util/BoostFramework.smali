...
.field public static final PROFILE_INDEX_BENCHMARK:I = 0x7

.field public static final PROFILE_INDEX_GPS_NAVI:I = 0x9

.field public static final PROFILE_INDEX_PERFORMANCE:I = 0x8

.field public static final PROFILE_INDEX_RELEASE:I = -0x1

.field public static final PROFILE_INDEX_RESERVED_0:I = 0x0

.field public static final PROFILE_INDEX_RESERVED_1:I = 0x1

.field public static final PROFILE_INDEX_RESERVED_2:I = 0x2

.field public static final PROFILE_INDEX_RESERVED_3:I = 0x3

.field public static final PROFILE_INDEX_RESERVED_4:I = 0x4

.field public static final PROFILE_INDEX_RESERVED_5:I = 0x5

.field public static final PROFILE_INDEX_RESERVED_6:I = 0x6

.field public static final PROFILE_INDEX_VIDEO_CALL:I = 0xb

.field public static final PROFILE_INDEX_WIFI_STEAMING:I = 0xa
...
.field private static mUseProfile:Ljava/lang/reflect/Method;
...
.method static constructor <clinit>()V
    ...
    .line 53
    sput-object v1, Landroid/util/BoostFramework;->mUseProfile:Ljava/lang/reflect/Method;
...
.method public constructor <init>()V
    ...
    iput-object v6, p0, Landroid/util/BoostFramework;->mPerf:Ljava/lang/Object;

    .line 85
    sget-boolean v6, Landroid/util/BoostFramework;->mIsLoaded:Z
    ...
    .line 92
    .local v5, "perfClassLoader":Ldalvik/system/PathClassLoader;
    ...
    .line 93
    .local v4, "perfClass":Ljava/lang/Class;
    const/4 v6, 0x0
    ...
    sput-object v6, Landroid/util/BoostFramework;->mConstructor:Ljava/lang/reflect/Constructor;
    ...
    sput-object v6, Landroid/util/BoostFramework;->mAcquireFunc:Ljava/lang/reflect/Method;
    ...
    const-string/jumbo v8, "mAcquireFunc method = "

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    sget-object v8, Landroid/util/BoostFramework;->mAcquireFunc:Ljava/lang/reflect/Method;
    ...
    sput-object v6, Landroid/util/BoostFramework;->mReleaseFunc:Ljava/lang/reflect/Method;
    ...
    const-string/jumbo v8, "mReleaseFunc method = "

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    sget-object v8, Landroid/util/BoostFramework;->mReleaseFunc:Ljava/lang/reflect/Method;
    ...
    const-string/jumbo v6, "perfLockAcquireTouch"

    invoke-virtual {v4, v6, v0}, Ljava/lang/Class;->getDeclaredMethod(Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Method;

    move-result-object v6

    sput-object v6, Landroid/util/BoostFramework;->mAcquireTouchFunc:Ljava/lang/reflect/Method;
    ...
    const-string/jumbo v8, "mAcquireTouchFunc method = "

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    sget-object v8, Landroid/util/BoostFramework;->mAcquireTouchFunc:Ljava/lang/reflect/Method;
    ...
    .line 108
    .restart local v0    # "argClasses":[Ljava/lang/Class;
    const-string/jumbo v6, "perfIOPrefetchStart"

    invoke-virtual {v4, v6, v0}, Ljava/lang/Class;->getDeclaredMethod(Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Method;

    move-result-object v6

    sput-object v6, Landroid/util/BoostFramework;->mIOPStart:Ljava/lang/reflect/Method;
    ...
    const-string/jumbo v8, "mIOPStart method = "

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    sget-object v8, Landroid/util/BoostFramework;->mIOPStart:Ljava/lang/reflect/Method;
    ...
    .line 112
    const-string/jumbo v6, "perfIOPrefetchStop"

    invoke-virtual {v4, v6, v0}, Ljava/lang/Class;->getDeclaredMethod(Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Method;

    move-result-object v6

    sput-object v6, Landroid/util/BoostFramework;->mIOPStop:Ljava/lang/reflect/Method;
    ...
    const-string/jumbo v8, "mIOPStop method = "

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    sget-object v8, Landroid/util/BoostFramework;->mIOPStop:Ljava/lang/reflect/Method;
    ...
    :try_start_2
    const-string/jumbo v6, "perfLockUseProfile"

    invoke-virtual {v4, v6, v1}, Ljava/lang/Class;->getDeclaredMethod(Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Method;

    move-result-object v6

    sput-object v6, Landroid/util/BoostFramework;->mUseProfile:Ljava/lang/reflect/Method;
    ...
    const-string/jumbo v8, "mUseProfile method = "

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    sget-object v8, Landroid/util/BoostFramework;->mUseProfile:Ljava/lang/reflect/Method;
    ...
    :try_start_3
    sput-boolean v6, Landroid/util/BoostFramework;->mIsLoaded:Z
    :try_end_3
    .catch Ljava/lang/Exception; {:try_start_3 .. :try_end_3} :catch_1

    .line 131
    .end local v0    # "argClasses":[Ljava/lang/Class;
    .end local v4    # "perfClass":Ljava/lang/Class;
    .end local v5    # "perfClassLoader":Ldalvik/system/PathClassLoader;
    :cond_0
    :goto_1
    :try_start_4
    sget-object v6, Landroid/util/BoostFramework;->mConstructor:Ljava/lang/reflect/Constructor;
    ...
    const-string v8, "BoostFramework() : mPerf = "

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    iget-object v8, p0, Landroid/util/BoostFramework;->mPerf:Ljava/lang/Object;
    ...
    .line 119
    .restart local v0    # "argClasses":[Ljava/lang/Class;
    .restart local v4    # "perfClass":Ljava/lang/Class;
    .restart local v5    # "perfClassLoader":Ldalvik/system/PathClassLoader;
    :catch_0
    move-exception v3
    ...
    const-string v8, "BoostFramework() : Exception_2 = "
    ...
    .line 119
    .end local v2    # "e":Ljava/lang/Exception;
    .restart local v1    # "argClasses":[Ljava/lang/Class;
    .restart local v4    # "perfClass":Ljava/lang/Class;
    .restart local v5    # "perfClassLoader":Ldalvik/system/PathClassLoader;
    :catch_3
    move-exception v3
...
.method public perfLockUseProfile(II)I
    .locals 8
    .param p1, "handle"    # I
    .param p2, "profile"    # I
    ...
    .local v1, "ret":I
    :try_start_0
    sget-object v3, Landroid/util/BoostFramework;->mUseProfile:Ljava/lang/reflect/Method;
