...
.field public static final DEFAULT_CALENDAR_URI:Landroid/net/Uri;

.field public static final DEFAULT_MAIL_URI:Landroid/net/Uri;

.field public static final DEFAULT_MESSAGE_DELIVER_URI:Landroid/net/Uri;
...
.field public static final DEFAULT_RINGTONE_URI_FOR_SLOT2:Landroid/net/Uri;
...
.field public static final LE_FONT_SCALE:Ljava/lang/String; = "le_font_scale"
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/provider/Settings$System;->DEFAULT_CALENDAR_URI:Landroid/net/Uri;

    .line 2833
    const-string/jumbo v0, "message_deliver_sound"

    invoke-static {v0}, Landroid/provider/Settings$System;->getUriFor(Ljava/lang/String;)Landroid/net/Uri;

    move-result-object v0

    sput-object v0, Landroid/provider/Settings$System;->DEFAULT_MESSAGE_DELIVER_URI:Landroid/net/Uri;

    .line 2842
    const-string/jumbo v0, "leui_ringtone_slot2"

    invoke-static {v0}, Landroid/provider/Settings$System;->getUriFor(Ljava/lang/String;)Landroid/net/Uri;

    move-result-object v0

    sput-object v0, Landroid/provider/Settings$System;->DEFAULT_RINGTONE_URI_FOR_SLOT2:Landroid/net/Uri;
    ...
    const-string/jumbo v2, "leui_key_position_policy"
    ...
    const-string/jumbo v1, "le_font_scale"
    ...
    const-string/jumbo v1, "leui_screen_brightness_vr"
...
.method public static clearConfiguration(Landroid/content/res/Configuration;)V
    ...
    .line 2020
    iput v0, p0, Landroid/content/res/Configuration;->leFontScale:F
...
.method public static getConfigurationForUser(Landroid/content/ContentResolver;Landroid/content/res/Configuration;I)V
    ...
    .line 2005
    :cond_0
    const-string/jumbo v0, "le_font_scale"

    iget v1, p1, Landroid/content/res/Configuration;->leFontScale:F

    invoke-static {p0, v0, v1, p2}, Landroid/provider/Settings$System;->getFloatForUser(Landroid/content/ContentResolver;Ljava/lang/String;FI)F

    move-result v0

    iput v0, p1, Landroid/content/res/Configuration;->leFontScale:F

    .line 2007
    iget v0, p1, Landroid/content/res/Configuration;->leFontScale:F
    ...
    .line 2008
    iput v3, p1, Landroid/content/res/Configuration;->leFontScale:F
...
.method public static putConfigurationForUser(Landroid/content/ContentResolver;Landroid/content/res/Configuration;I)Z
    ...
    invoke-static {p0, v1, v2, p2}, Landroid/provider/Settings$System;->putFloatForUser(Landroid/content/ContentResolver;Ljava/lang/String;FI)Z
    ...
    iget v2, p1, Landroid/content/res/Configuration;->leFontScale:F
