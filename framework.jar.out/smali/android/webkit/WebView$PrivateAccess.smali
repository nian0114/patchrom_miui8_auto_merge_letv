...
.method public awakenScrollBars(I)V
    ...
    invoke-static {v0, p1}, Landroid/webkit/WebView;->access$1600(Landroid/webkit/WebView;I)Z
...
.method public awakenScrollBars(IZ)V
    ...
    invoke-static {v0, p1, p2}, Landroid/webkit/WebView;->access$1700(Landroid/webkit/WebView;IZ)Z
...
.method public getHorizontalScrollFactor()F
    ...
    invoke-static {v0}, Landroid/webkit/WebView;->access$1900(Landroid/webkit/WebView;)F
...
.method public overScrollBy(IIIIIIIIZ)V
    ...
    invoke-static/range {v0 .. v9}, Landroid/webkit/WebView;->access$1500(Landroid/webkit/WebView;IIIIIIIIZ)Z
...
.method public setMeasuredDimension(II)V
    ...
    invoke-static {v0, p1, p2}, Landroid/webkit/WebView;->access$2000(Landroid/webkit/WebView;II)V
...
.method public setScrollYRaw(I)V
    ...
    invoke-static {v0, p1}, Landroid/webkit/WebView;->access$2402(Landroid/webkit/WebView;I)I
...
.method public super_computeScroll()V
    ...
    invoke-static {v0}, Landroid/webkit/WebView;->access$601(Landroid/webkit/WebView;)V
...
.method public super_dispatchKeyEvent(Landroid/view/KeyEvent;)Z
    ...
    invoke-static {v0, p1}, Landroid/webkit/WebView;->access$1101(Landroid/webkit/WebView;Landroid/view/KeyEvent;)Z
...
.method public super_getScrollBarStyle()I
    ...
    invoke-static {v0}, Landroid/webkit/WebView;->access$401(Landroid/webkit/WebView;)I
...
.method public super_onDrawVerticalScrollBar(Landroid/graphics/Canvas;Landroid/graphics/drawable/Drawable;IIII)V
    ...
    invoke-static/range {v0 .. v6}, Landroid/webkit/WebView;->access$2201(Landroid/webkit/WebView;Landroid/graphics/Canvas;Landroid/graphics/drawable/Drawable;IIII)V
...
.method public super_onGenericMotionEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-static {v0, p1}, Landroid/webkit/WebView;->access$1201(Landroid/webkit/WebView;Landroid/view/MotionEvent;)Z
...
.method public super_onHoverEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-static {v0, p1}, Landroid/webkit/WebView;->access$701(Landroid/webkit/WebView;Landroid/view/MotionEvent;)Z
...
.method public super_performAccessibilityAction(ILandroid/os/Bundle;)Z
    ...
    invoke-static {v0, p1, p2}, Landroid/webkit/WebView;->access$801(Landroid/webkit/WebView;ILandroid/os/Bundle;)Z
...
.method public super_performLongClick()Z
    ...
    invoke-static {v0}, Landroid/webkit/WebView;->access$901(Landroid/webkit/WebView;)Z
...
.method public super_requestFocus(ILandroid/graphics/Rect;)Z
    ...
    invoke-static {v0, p1, p2}, Landroid/webkit/WebView;->access$1301(Landroid/webkit/WebView;ILandroid/graphics/Rect;)Z
...
.method public super_scrollTo(II)V
    ...
    invoke-static {v0, p1, p2}, Landroid/webkit/WebView;->access$501(Landroid/webkit/WebView;II)V
...
.method public super_setFrame(IIII)Z
    ...
    invoke-static {v0, p1, p2, p3, p4}, Landroid/webkit/WebView;->access$1001(Landroid/webkit/WebView;IIII)Z
...
.method public super_setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-static {v0, p1}, Landroid/webkit/WebView;->access$1401(Landroid/webkit/WebView;Landroid/view/ViewGroup$LayoutParams;)V
