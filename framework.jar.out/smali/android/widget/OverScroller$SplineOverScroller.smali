...
.method finish()V
    ...
    # getter for: Landroid/widget/OverScroller;->perfService:Lcom/letv/leui/perfservice/IPerfService;
    invoke-static {}, Landroid/widget/OverScroller;->access$800()Lcom/letv/leui/perfservice/IPerfService;
    ...
    invoke-interface {v1, v2}, Lcom/letv/leui/perfservice/IPerfService;->boostDisable(I)V
    :try_end_0
...
.method fling(IIIII)V
    ...
    iput-boolean v12, v0, Landroid/widget/OverScroller$SplineOverScroller;->mFinished:Z
    ...
    iput v12, v0, Landroid/widget/OverScroller$SplineOverScroller;->mSplineDuration:I

    move-object/from16 v0, p0

    iput v12, v0, Landroid/widget/OverScroller$SplineOverScroller;->mDuration:I
    ...
    iget-boolean v12, v0, Landroid/widget/OverScroller$SplineOverScroller;->mIsPerfLockAcquired:Z
    ...
    invoke-interface {v12, v13}, Lcom/letv/leui/perfservice/IPerfService;->boostDisable(I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_1
    ...
    iput-boolean v12, v0, Landroid/widget/OverScroller$SplineOverScroller;->mIsPerfLockAcquired:Z
    ...
    iput v12, v0, Landroid/widget/OverScroller$SplineOverScroller;->mState:I
    ...
    iget-boolean v12, v0, Landroid/widget/OverScroller$SplineOverScroller;->mEnableOverScrollForLe:Z

    if-eqz v12, :cond_5

    move-object/from16 v0, p0

    iget v12, v0, Landroid/widget/OverScroller$SplineOverScroller;->mFlingTestCount:I
    ...
    iput-boolean v12, v0, Landroid/widget/OverScroller$SplineOverScroller;->mSmoothFling:Z
    ...
    iput v12, v0, Landroid/widget/OverScroller$SplineOverScroller;->mFlingTestCount:I
    ...
    iput v12, v0, Landroid/widget/OverScroller$SplineOverScroller;->mUpdateCount:I

    .line 895
    move-object/from16 v0, p0

    iget-boolean v12, v0, Landroid/widget/OverScroller$SplineOverScroller;->mSmoothFling:Z
    ...
    iput v12, v0, Landroid/widget/OverScroller$SplineOverScroller;->mDecelerationSpeed:I
    ...
    iput v12, v0, Landroid/widget/OverScroller$SplineOverScroller;->mIterateCount:I
    ...
    iput v12, v0, Landroid/widget/OverScroller$SplineOverScroller;->mLastDistance:F
    ...
    iput v12, v0, Landroid/widget/OverScroller$SplineOverScroller;->mCoeffDeceleration:F
    ...
    iget v13, v0, Landroid/widget/OverScroller$SplineOverScroller;->mDecelerationSpeed:I
    ...
    iput v12, v0, Landroid/widget/OverScroller$SplineOverScroller;->mDelta:F

    .line 913
    :goto_3
    move-object/from16 v0, p0

    iget v12, v0, Landroid/widget/OverScroller$SplineOverScroller;->mDelta:F
    ...
    iget v0, v0, Landroid/widget/OverScroller$SplineOverScroller;->mCoeffDeceleration:F
    ...
    iget v15, v0, Landroid/widget/OverScroller$SplineOverScroller;->mCoeffDeceleration:F
    ...
    iget v12, v0, Landroid/widget/OverScroller$SplineOverScroller;->mStart:I
    ...
    iput v12, v0, Landroid/widget/OverScroller$SplineOverScroller;->mFinal:I
    ...
    iput v12, v0, Landroid/widget/OverScroller$SplineOverScroller;->mSplineDistance:I

    .line 934
    move-object/from16 v0, p0

    iget v12, v0, Landroid/widget/OverScroller$SplineOverScroller;->mSplineDistance:I
    ...
    iget v13, v0, Landroid/widget/OverScroller$SplineOverScroller;->mFinal:I

    move-object/from16 v0, p0

    move/from16 v1, p3

    invoke-direct {v0, v12, v13, v1}, Landroid/widget/OverScroller$SplineOverScroller;->adjustDuration(III)V
...
.method update()Z
    ...
    iget v3, v0, Landroid/widget/OverScroller$SplineOverScroller;->flingBoostTimeOut:I
    ...
    invoke-interface {v3, v6}, Lcom/letv/leui/perfservice/IPerfService;->boostEnable(I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_1
