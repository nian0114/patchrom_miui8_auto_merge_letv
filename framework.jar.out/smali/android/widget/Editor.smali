...
.method onTouchUpEvent(Landroid/view/MotionEvent;)V
    ...
    invoke-virtual/range {v17 .. v17}, Landroid/widget/TextView;->didTouchFocusSelect()Z
    ...
    invoke-virtual/range {v17 .. v18}, Landroid/widget/TextView;->convertToLocalHorizontalCoordinate(F)F

    move-result v13

    .local v13, "touchPos":F
    move-object/from16 v0, p0
    ...
    iget v8, v0, Landroid/widget/Editor;->mPreOffset:I
    ...
    .end local v9    # "offsetPos":F
    .end local v10    # "paint":Landroid/text/TextPaint;
    .end local v13    # "touchPos":F
    .end local v14    # "touchSlop":I
    .end local v15    # "viewConfiguration":Landroid/view/ViewConfiguration;
    .end local v16    # "widthThread":F
    :cond_4
    :goto_2
    const/16 v17, -0x1
    ...
    invoke-static {v12, v8}, Landroid/text/Selection;->setSelection(Landroid/text/Spannable;I)V
    ...
    invoke-virtual/range {v17 .. v18}, Landroid/widget/TextView;->removeCallbacks(Ljava/lang/Runnable;)Z

    :cond_6
    new-instance v17, Landroid/widget/Editor$2;
    ...
    .end local v11    # "selectAllGotFocus":Z
    :cond_8
    const/4 v11, 0x0

    goto/16 :goto_0

    .restart local v11    # "selectAllGotFocus":Z
    :cond_9
    const/4 v4, 0x0
    ...
    .restart local v9    # "offsetPos":F
    .restart local v10    # "paint":Landroid/text/TextPaint;
    .restart local v12    # "text":Ljava/lang/CharSequence;
    .restart local v13    # "touchPos":F
    .restart local v14    # "touchSlop":I
    .restart local v15    # "viewConfiguration":Landroid/view/ViewConfiguration;
    .restart local v16    # "widthThread":F
    :cond_a
    const/16 v17, 0x0
    ...
    invoke-virtual/range {v17 .. v17}, Landroid/widget/Editor$InsertionPointCursorController;->showWidthActionPopup()V

    :cond_c
    move-object/from16 v0, p0

    iput v8, v0, Landroid/widget/Editor;->mPreOffset:I
