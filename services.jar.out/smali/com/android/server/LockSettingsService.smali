...
.field private mLeuiLockSettingsServiceHelper:Lcom/android/server/LeuiLockSettingsServiceHelper;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v0, p0}, Lcom/android/server/LockSettingsService$5;-><init>(Lcom/android/server/LockSettingsService;)V

    iput-object v0, p0, Lcom/android/server/LockSettingsService;->mLockSettingsServiceCallback:Lcom/android/server/LeuiLockSettingsServiceHelper$LockSettingsServiceCallback;
    ...
    .line 136
    new-instance v0, Lcom/android/server/LeuiLockSettingsServiceHelper;
    ...
    iget-object v2, p0, Lcom/android/server/LockSettingsService;->mLockSettingsServiceCallback:Lcom/android/server/LeuiLockSettingsServiceHelper$LockSettingsServiceCallback;

    invoke-direct {v0, p1, v1, v2}, Lcom/android/server/LeuiLockSettingsServiceHelper;-><init>(Landroid/content/Context;Lcom/android/internal/widget/LockPatternUtils;Lcom/android/server/LeuiLockSettingsServiceHelper$LockSettingsServiceCallback;)V

    iput-object v0, p0, Lcom/android/server/LockSettingsService;->mLeuiLockSettingsServiceHelper:Lcom/android/server/LeuiLockSettingsServiceHelper;
...
.method static synthetic access$700(Lcom/android/server/LockSettingsService;I)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/LockSettingsService;
    .param p1, "x1"    # I
...
.method static synthetic access$800(Lcom/android/server/LockSettingsService;I)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/LockSettingsService;
    .param p1, "x1"    # I
...
.method private initControlStatus()V
    ...
    .line 951
    const-string v1, "PhoneControl"

    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    const-string v3, "[LockSettingsService] initControlStatus, mDescriptor: "
    ...
    .line 956
    iget-object v2, p0, Lcom/android/server/LockSettingsService;->mFileLock:Ljava/lang/Object;
...
.method private verifyCredential(ILcom/android/server/LockSettingsStorage$CredentialHash;Ljava/lang/String;ZJLcom/android/server/LockSettingsService$CredentialUtil;)Lcom/android/internal/widget/VerifyCredentialResponse;
    ...
    const-string v5, "verifyCredential(),start ~"
    ...
    .line 698
    .local v16, "mStartTrackTime":J
    move-wide/from16 v14, v16

    .line 699
    .local v14, "mLastTrackTime":J
    ...
    .line 708
    new-instance v18, Lcom/android/internal/widget/VerifyCredentialResponse;
    ...
    invoke-direct {v0, v4}, Lcom/android/internal/widget/VerifyCredentialResponse;-><init>(I)V

    .line 722
    .local v18, "response":Lcom/android/internal/widget/VerifyCredentialResponse;
    :goto_1
    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J
    ...
    const-string v6, "verifyCredential(),one , pass:"
    ...
    :goto_2
    invoke-virtual/range {v18 .. v18}, Lcom/android/internal/widget/VerifyCredentialResponse;->getResponseCode()I
    ...
    const-string v6, "verifyCredential(),three , pass:"
    ...
    iget-object v4, v0, Lcom/android/server/LockSettingsService;->mLeuiLockSettingsServiceHelper:Lcom/android/server/LeuiLockSettingsServiceHelper;

    move/from16 v0, p1

    move-object/from16 v1, v18

    invoke-virtual {v4, v0, v1}, Lcom/android/server/LeuiLockSettingsServiceHelper;->checkVeryfyResponse(ILcom/android/internal/widget/VerifyCredentialResponse;)Lcom/android/internal/widget/VerifyCredentialResponse;
    ...
    const-string v6, "verifyCredential(),in "
    ...
    .line 709
    .end local v18    # "response":Lcom/android/internal/widget/VerifyCredentialResponse;
    ...
    .restart local v18    # "response":Lcom/android/internal/widget/VerifyCredentialResponse;
    goto/16 :goto_1
    ...
    const-string v6, "verifyCredential(),two , pass:"
    ...
    .line 755
    invoke-virtual/range {v18 .. v18}, Lcom/android/internal/widget/VerifyCredentialResponse;->getTimeout()I
    ...
    const-string v6, "verifyCredential(),four , pass:"
...
.method public checkLeuiPassword(Ljava/lang/String;ILjava/lang/String;)Lcom/android/internal/widget/VerifyCredentialResponse;
    ...
    .prologue
    .line 1155
    iget-object v0, p0, Lcom/android/server/LockSettingsService;->mLeuiLockSettingsServiceHelper:Lcom/android/server/LeuiLockSettingsServiceHelper;

    invoke-virtual {v0, p1, p2, p3}, Lcom/android/server/LeuiLockSettingsServiceHelper;->checkLeuiPassword(Ljava/lang/String;ILjava/lang/String;)Lcom/android/internal/widget/VerifyCredentialResponse;
...
.method public checkLeuiPattern(Ljava/lang/String;ILjava/lang/String;)Lcom/android/internal/widget/VerifyCredentialResponse;
    ...
    invoke-virtual {v0, p1, p2, p3}, Lcom/android/server/LeuiLockSettingsServiceHelper;->checkLeuiPattern(Ljava/lang/String;ILjava/lang/String;)Lcom/android/internal/widget/VerifyCredentialResponse;
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    const-string v1, "Permission Denial: can\'t dump LockSettingsService from from pid="
    ...
    .line 1089
    :cond_0
    const-string v0, "LOCK MANAGER (dumpsys lock_settings)\n"

    invoke-virtual {p2, v0}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    .line 1090
    const-string v0, "Phone control status: "
    ...
    .line 1096
    const-string v0, "    [mActivateValue]: "
    ...
    invoke-virtual {v0, p1, p2, p3}, Lcom/android/server/LeuiLockSettingsServiceHelper;->dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
...
.method public haveLeuiPassword(ILjava/lang/String;)Z
    ...
    invoke-virtual {v0, p1, p2}, Lcom/android/server/LeuiLockSettingsServiceHelper;->haveLeuiPassword(ILjava/lang/String;)Z
...
.method public haveLeuiPattern(ILjava/lang/String;)Z
    ...
    invoke-virtual {v0, p1, p2}, Lcom/android/server/LeuiLockSettingsServiceHelper;->haveLeuiPattern(ILjava/lang/String;)Z
...
.method public setLeuiPassword(Ljava/lang/String;ILjava/lang/String;)V
    ...
    invoke-virtual {v0, p1, p2, p3}, Lcom/android/server/LeuiLockSettingsServiceHelper;->setLeuiPassword(Ljava/lang/String;ILjava/lang/String;)V
...
.method public setLeuiPattern(Ljava/lang/String;ILjava/lang/String;)V
    ...
    invoke-virtual {v0, p1, p2, p3}, Lcom/android/server/LeuiLockSettingsServiceHelper;->setLeuiPattern(Ljava/lang/String;ILjava/lang/String;)V
...
.method public writeControlStatus(II)I
    ...
    const-string v3, "[LockSettingsService] writeControlStatus...mBindValue: "
    ...
    const-string v3, "[LockSettingsService] writeControlStatus...mLockValue: "
    ...
    const-string v3, "[LockSettingsService] writeControlStatus...mWipeValue: "
    ...
    const-string v3, "[LockSettingsService] writeControlStatus...mActivateValue: "
