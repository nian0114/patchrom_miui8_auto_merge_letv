...
.field private static final GPS_FIX_TIMEOUT:J = 0x1d4c0L
...
.field private static final GPS_LOCATION_LOST:Ljava/lang/String; = "GPS_LOCATION_LOST"
...
.field private static final GPS_TTFF_TOOLONG:Ljava/lang/String; = "GPS_TTFF_TOOLONG"
...
.field private static final LOST_FIX_TIMEOUT:J = 0xea60L
...
.method private reportLocation(IDDDFFFJ)V
    ...
    .line 1438
    const-string v4, "GPS_TTFF_TOOLONG"

    new-instance v5, Ljava/lang/StringBuilder;

    invoke-direct {v5}, Ljava/lang/StringBuilder;-><init>()V

    const-string v6, "Location time too long, ttff:"
    ...
    invoke-direct {p0, v4, v5}, Lcom/android/server/location/GpsLocationProvider;->sendGPSBugReportBroadcast(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v6, "reportLocation2: ttff"
    ...
    const-string v6, "reportLocation1: ttff"
...
.method private sendGPSBugReportBroadcast(Ljava/lang/String;Ljava/lang/String;)V
    .locals 6
    ...
    const-string v4, "hjr sendGPSBugReportBroadcast tag="
    ...
    const-string v3, "/sdcard/logs"

    aput-object v3, v1, v2

    const/4 v2, 0x1

    const-string v3, "/sdcard/mtklog"
    ...
    const-string v2, "letv.intent.action.crashhandler.FREE_REPORT_BUG"

    invoke-direct {v0, v2}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .line 501
    .local v0, "bugintent":Landroid/content/Intent;
    const-string v2, "tag"

    const-string v3, "GPS_LOACATION_FAILED"
    ...
    const-string v3, "com.android.location"
...
.method private startNavigating(Z)V
    ...
    .line 1335
    :cond_6
    const-string v0, "persist.sys.usb.gps.notify"
...
.method private updateLowPowerMode()V
    ...
    invoke-virtual {v1}, Landroid/os/PowerManager;->isPowerSaveModeOfEUI()Z
