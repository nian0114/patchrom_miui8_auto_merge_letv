...
.field private static final FLAG_NONFREEFLOW_TAG:I = 0x3d0c3542
...
.method private recordSnapshotLocked(J)V
    ...
    invoke-static {v0, v1, v12}, Lcom/android/server/NetPluginDelegate;->getTetherStats(Landroid/net/NetworkStats;Landroid/net/NetworkStats;Landroid/net/NetworkStats;)V
    ...
    .line 1080
    .local v14, "freeflowSnapshot":Landroid/net/NetworkStats;
    ...
    .line 1083
    invoke-virtual {v14, v15, v13}, Landroid/net/NetworkStats;->getValues(ILandroid/net/NetworkStats$Entry;)Landroid/net/NetworkStats$Entry;
    ...
    .line 1094
    .local v17, "nonfreeflowSnapshot":Landroid/net/NetworkStats;
    if-eqz v17, :cond_2
    ...
    .line 1096
    .local v5, "nonresult":Landroid/net/NetworkStats;
    const/16 v16, 0x0

    .line 1097
    .local v16, "nonentry":Landroid/net/NetworkStats$Entry;
    const/4 v15, 0x0
    ...
    invoke-virtual {v5, v0}, Landroid/net/NetworkStats;->combineValues(Landroid/net/NetworkStats$Entry;)Landroid/net/NetworkStats;
    ...
    .line 1106
    .end local v5    # "nonresult":Landroid/net/NetworkStats;
    .end local v16    # "nonentry":Landroid/net/NetworkStats$Entry;
    :cond_2
    move-object/from16 v0, p0
    ...
    iget-object v8, v0, Lcom/android/server/net/NetworkStatsService;->mActiveUidIfaces:Landroid/util/ArrayMap;
    ...
    invoke-virtual/range {v6 .. v11}, Lcom/android/server/net/NetworkStatsRecorder;->recordSnapshotLocked(Landroid/net/NetworkStats;Ljava/util/Map;[Lcom/android/internal/net/VpnInfo;J)V
