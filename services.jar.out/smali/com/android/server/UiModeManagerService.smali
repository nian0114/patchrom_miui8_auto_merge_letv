...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput v0, p0, Lcom/android/server/UiModeManagerService;->mOledMode:I
...
.method static synthetic access$400(Lcom/android/server/UiModeManagerService;)I
    ...
    .prologue
    .line 55
    iget v0, p0, Lcom/android/server/UiModeManagerService;->mOledMode:I
...
.method static synthetic access$402(Lcom/android/server/UiModeManagerService;I)I
    ...
    .prologue
    .line 55
    iput p1, p0, Lcom/android/server/UiModeManagerService;->mOledMode:I
...
.method private updateConfigurationLocked()V
    ...
    .line 424
    :goto_2
    iget v1, p0, Lcom/android/server/UiModeManagerService;->mOledMode:I
...
.method public onStart()V
    ...
    invoke-virtual {v4, v6, v9}, Landroid/os/PowerManager;->newWakeLock(ILjava/lang/String;)Landroid/os/PowerManager$WakeLock;

    move-result-object v6

    iput-object v6, p0, Lcom/android/server/UiModeManagerService;->mWakeLock:Landroid/os/PowerManager$WakeLock;

    .line 166
    iget-object v6, p0, Lcom/android/server/UiModeManagerService;->mDockModeReceiver:Landroid/content/BroadcastReceiver;
    ...
    invoke-virtual {v0, v6, v9}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;

    .line 168
    iget-object v6, p0, Lcom/android/server/UiModeManagerService;->mBatteryReceiver:Landroid/content/BroadcastReceiver;
    ...
    .line 171
    iget-object v6, p0, Lcom/android/server/UiModeManagerService;->mConfiguration:Landroid/content/res/Configuration;
    ...
    iput v6, p0, Lcom/android/server/UiModeManagerService;->mDefaultUiModeType:I
    ...
    :goto_0
    iput-boolean v6, p0, Lcom/android/server/UiModeManagerService;->mCarModeKeepsScreenOn:Z
    ...
    :goto_1
    iput-boolean v6, p0, Lcom/android/server/UiModeManagerService;->mDeskModeKeepsScreenOn:Z
    ...
    :cond_1
    iput-boolean v8, p0, Lcom/android/server/UiModeManagerService;->mTelevision:Z
    ...
    .line 194
    .local v2, "defaultOledMode":I
    invoke-virtual {v0}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v6

    const-string v7, "ui_eui_oled_mode"

    invoke-static {v6, v7, v2}, Landroid/provider/Settings$Secure;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I

    move-result v6

    iput v6, p0, Lcom/android/server/UiModeManagerService;->mOledMode:I
    ...
    iget-object v7, p0, Lcom/android/server/UiModeManagerService;->mService:Landroid/os/IBinder;

    invoke-virtual {p0, v6, v7}, Lcom/android/server/UiModeManagerService;->publishBinderService(Ljava/lang/String;Landroid/os/IBinder;)V

    .line 205
    return-void

    .end local v1    # "defaultNightMode":I
    .end local v2    # "defaultOledMode":I
    ...
    .restart local v2    # "defaultOledMode":I
