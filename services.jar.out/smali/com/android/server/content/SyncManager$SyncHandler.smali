...
.method private runBoundToAdapter(Lcom/android/server/content/SyncManager$ActiveSyncContext;Landroid/os/IBinder;)V
    ...
    # getter for: Lcom/android/server/content/SyncManager;->mContext:Landroid/content/Context;
    invoke-static {v4}, Lcom/android/server/content/SyncManager;->access$1900(Lcom/android/server/content/SyncManager;)Landroid/content/Context;
    ...
    iget-object v4, v3, Lcom/android/server/content/SyncOperation;->extras:Landroid/os/Bundle;
    ...
    iput-object v4, v3, Lcom/android/server/content/SyncOperation;->extras:Landroid/os/Bundle;
    ...
    iget v6, v3, Lcom/android/server/content/SyncOperation;->reason:I

    invoke-static {v1, v6}, Lcom/android/server/content/SyncOperation;->reasonToString(Landroid/content/pm/PackageManager;I)Ljava/lang/String;
    ...
    iget-boolean v4, v4, Lcom/android/server/content/SyncStorageEngine$EndPoint;->target_provider:Z
    ...
    iget-object v7, v3, Lcom/android/server/content/SyncOperation;->extras:Landroid/os/Bundle;
    ...
    iget-boolean v4, v4, Lcom/android/server/content/SyncStorageEngine$EndPoint;->target_service:Z
    ...
    iput-object v4, p1, Lcom/android/server/content/SyncManager$ActiveSyncContext;->mSyncServiceAdapter:Landroid/content/ISyncServiceAdapter;

    iget-object v4, p1, Lcom/android/server/content/SyncManager$ActiveSyncContext;->mSyncServiceAdapter:Landroid/content/ISyncServiceAdapter;

    iget-object v5, v3, Lcom/android/server/content/SyncOperation;->extras:Landroid/os/Bundle;

    invoke-interface {v4, p1, v5}, Landroid/content/ISyncServiceAdapter;->startSync(Landroid/content/ISyncContext;Landroid/os/Bundle;)V
    :try_end_0
    ...
    .local v2, "remoteExc":Landroid/os/RemoteException;
    const-string v4, "SyncManager"

    const-string v5, "maybeStartNextSync: caught a RemoteException, rescheduling"
    ...
    # invokes: Lcom/android/server/content/SyncManager;->increaseBackoffSetting(Lcom/android/server/content/SyncOperation;)V
    invoke-static {v4, v3}, Lcom/android/server/content/SyncManager;->access$3500(Lcom/android/server/content/SyncManager;Lcom/android/server/content/SyncOperation;)V
    ...
    invoke-direct {v5, v3, v6, v7}, Lcom/android/server/content/SyncOperation;-><init>(Lcom/android/server/content/SyncOperation;J)V

    invoke-virtual {v4, v5}, Lcom/android/server/content/SyncManager;->scheduleSyncOperation(Lcom/android/server/content/SyncOperation;)V

    goto :goto_0

    .end local v2    # "remoteExc":Landroid/os/RemoteException;
    :catch_1
    move-exception v0
    ...
    const-string v6, "Caught RuntimeException while starting the sync "
