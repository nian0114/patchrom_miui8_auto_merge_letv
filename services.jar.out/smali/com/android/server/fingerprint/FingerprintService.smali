...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/server/fingerprint/FingerprintService$LivingDetectionObserver;,
...
.field private static final FINGERPRINT_GX_MODE_NAV:I = 0x1

.field private static final FINGERPRINT_GX_MODE_SLEEP:I = 0x0
...
.field private static final MSG_UPDATE_DEFAULT_MODE:I = 0x2
...
.field private mLivingDetectionEnable:Z
...
.field private mNavigationEnable:Z
...
.field private mUpdateModeHandler:Landroid/os/Handler;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 1344
    iput-boolean v6, p0, Lcom/android/server/fingerprint/FingerprintService;->mLivingDetectionEnable:Z

    .line 1347
    iput-boolean v6, p0, Lcom/android/server/fingerprint/FingerprintService;->mNavigationEnable:Z

    .line 1348
    new-instance v5, Lcom/android/server/fingerprint/FingerprintService$4;

    invoke-direct {v5, p0}, Lcom/android/server/fingerprint/FingerprintService$4;-><init>(Lcom/android/server/fingerprint/FingerprintService;)V

    iput-object v5, p0, Lcom/android/server/fingerprint/FingerprintService;->mUpdateModeHandler:Landroid/os/Handler;

    .line 1377
    new-instance v5, Lcom/android/server/fingerprint/FingerprintService$5;

    invoke-direct {v5, p0}, Lcom/android/server/fingerprint/FingerprintService$5;-><init>(Lcom/android/server/fingerprint/FingerprintService;)V

    iput-object v5, p0, Lcom/android/server/fingerprint/FingerprintService;->mBootCompleteReceiver:Landroid/content/BroadcastReceiver;
...
.method static synthetic access$1900(Lcom/android/server/fingerprint/FingerprintService;)Lcom/android/server/fingerprint/FingerprintExtend;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/fingerprint/FingerprintService;
...
.method static synthetic access$2000(Lcom/android/server/fingerprint/FingerprintService;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/fingerprint/FingerprintService;

    .prologue
    .line 118
    iget-boolean v0, p0, Lcom/android/server/fingerprint/FingerprintService;->mLivingDetectionEnable:Z

    return v0
.end method

.method static synthetic access$2002(Lcom/android/server/fingerprint/FingerprintService;Z)Z
    .locals 0
    .param p0, "x0"    # Lcom/android/server/fingerprint/FingerprintService;
    .param p1, "x1"    # Z
    ...
    .prologue
    .line 118
    iput-boolean p1, p0, Lcom/android/server/fingerprint/FingerprintService;->mLivingDetectionEnable:Z

    return p1
.end method

.method static synthetic access$2100(Lcom/android/server/fingerprint/FingerprintService;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/fingerprint/FingerprintService;

    .prologue
    .line 118
    iget-boolean v0, p0, Lcom/android/server/fingerprint/FingerprintService;->mNavigationEnable:Z

    return v0
.end method

.method static synthetic access$2102(Lcom/android/server/fingerprint/FingerprintService;Z)Z
    .locals 0
    .param p0, "x0"    # Lcom/android/server/fingerprint/FingerprintService;
    .param p1, "x1"    # Z
    ...
    .prologue
    .line 118
    iput-boolean p1, p0, Lcom/android/server/fingerprint/FingerprintService;->mNavigationEnable:Z
...
.method static synthetic access$2200(Lcom/android/server/fingerprint/FingerprintService;)V
    ...
    .prologue
    .line 118
    invoke-direct {p0}, Lcom/android/server/fingerprint/FingerprintService;->registerNavigationObserver()V

    return-void
.end method

.method static synthetic access$2300(Lcom/android/server/fingerprint/FingerprintService;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/fingerprint/FingerprintService;

    .prologue
    .line 118
    invoke-direct {p0}, Lcom/android/server/fingerprint/FingerprintService;->registerLivingDetectionObserver()V

    return-void
.end method

.method static synthetic access$2500(Lcom/android/server/fingerprint/FingerprintService;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/fingerprint/FingerprintService;
...
.method static synthetic access$2600(Lcom/android/server/fingerprint/FingerprintService;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/fingerprint/FingerprintService;
...
.method private registerLivingDetectionObserver()V
    .locals 5
    ...
    invoke-static {v2}, Lcom/android/server/fingerprint/FingerprintUtils;->isLivingDetectionFuncEnable(Landroid/content/Context;)Z
    ...
    :goto_0
    iput-boolean v0, p0, Lcom/android/server/fingerprint/FingerprintService;->mLivingDetectionEnable:Z
    ...
    const-string v3, "init living detection status to :"

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget-boolean v3, p0, Lcom/android/server/fingerprint/FingerprintService;->mLivingDetectionEnable:Z
    ...
    const-string v2, "leui_finger_print_living_detection_enable"

    invoke-static {v2}, Landroid/provider/Settings$System;->getUriFor(Ljava/lang/String;)Landroid/net/Uri;

    move-result-object v2

    new-instance v3, Lcom/android/server/fingerprint/FingerprintService$LivingDetectionObserver;

    new-instance v4, Landroid/os/Handler;

    invoke-direct {v4}, Landroid/os/Handler;-><init>()V

    invoke-direct {v3, p0, v4}, Lcom/android/server/fingerprint/FingerprintService$LivingDetectionObserver;-><init>(Lcom/android/server/fingerprint/FingerprintService;Landroid/os/Handler;)V
...
.method private registerNavigationObserver()V
    .locals 5
    ...
    invoke-direct {v0, p0, v2}, Lcom/android/server/fingerprint/FingerprintService$6;-><init>(Lcom/android/server/fingerprint/FingerprintService;Landroid/os/Handler;)V

    .line 1451
    .local v0, "navigationObserver":Landroid/database/ContentObserver;
    invoke-virtual {p0}, Lcom/android/server/fingerprint/FingerprintService;->getContext()Landroid/content/Context;
    ...
    const-string v3, "leui_finger_print_navigation_enable"
    ...
    .line 1458
    .end local v0    # "navigationObserver":Landroid/database/ContentObserver;
    :cond_0
    return-void
.end method
...
.method protected handleAcquired(JI)V
    ...
    invoke-virtual {v1, p3}, Lcom/android/server/fingerprint/FingerprintExtend;->getVendorAcquireInfo(I)I
    ...
    const-string v3, "get Vendor acquired info from : "
    ...
    invoke-static {v1}, Lcom/android/server/fingerprint/FingerprintReport;->getInstance(Landroid/content/Context;)Lcom/android/server/fingerprint/FingerprintReport;

    move-result-object v1

    invoke-virtual {v1, p3}, Lcom/android/server/fingerprint/FingerprintReport;->checkIsFailedAcquireInfo(I)V
...
.method protected handleFidoAuthenticated(JII[B)V
    ...
    invoke-static {v1, p3, p4, p5}, Lcom/android/server/fingerprint/FingerprintService$ClientMonitor;->access$2700(Lcom/android/server/fingerprint/FingerprintService$ClientMonitor;II[B)Z
...
.method public onStart()V
    ...
    new-instance v4, Lcom/android/server/fingerprint/FingerprintService$FingerprintServiceWrapper;

    const/4 v5, 0x0

    invoke-direct {v4, p0, v5}, Lcom/android/server/fingerprint/FingerprintService$FingerprintServiceWrapper;-><init>(Lcom/android/server/fingerprint/FingerprintService;Lcom/android/server/fingerprint/FingerprintService$1;)V

    invoke-virtual {p0, v3, v4}, Lcom/android/server/fingerprint/FingerprintService;->publishBinderService(Ljava/lang/String;Landroid/os/IBinder;)V
    ...
    invoke-virtual {p0, v3}, Lcom/android/server/fingerprint/FingerprintService;->setDefaultMode(I)V
    ...
    invoke-static {v3}, Lcom/android/server/fingerprint/FingerprintReport;->getInstance(Landroid/content/Context;)Lcom/android/server/fingerprint/FingerprintReport;
    ...
    iget-object v4, p0, Lcom/android/server/fingerprint/FingerprintService;->mBootCompleteReceiver:Landroid/content/BroadcastReceiver;
    ...
    .line 1484
    iget-object v3, p0, Lcom/android/server/fingerprint/FingerprintService;->mUpdateModeHandler:Landroid/os/Handler;
    ...
    invoke-static {v3}, Lcom/android/server/fingerprint/FingerprintUtils;->isLivingDetectionFuncEnable(Landroid/content/Context;)Z
