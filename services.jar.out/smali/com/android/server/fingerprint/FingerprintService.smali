...
.field private static final MSG_SYNC_DATABASE:I = 0x14

.field private static final MSG_UPDATE_VERSION:I = 0x15
...
.field private mFingerprintExtendClass:Ljava/lang/Class;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v9, p0, Lcom/android/server/fingerprint/FingerprintService;->mAuthClient:Lcom/android/server/fingerprint/FingerprintService$ClientMonitor;

    iput-object v9, p0, Lcom/android/server/fingerprint/FingerprintService;->mEnrollClient:Lcom/android/server/fingerprint/FingerprintService$ClientMonitor;

    iput-object v9, p0, Lcom/android/server/fingerprint/FingerprintService;->mRemoveClient:Lcom/android/server/fingerprint/FingerprintService$ClientMonitor;

    new-instance v5, Ljava/util/ArrayList;

    invoke-direct {v5}, Ljava/util/ArrayList;-><init>()V

    iput-object v5, p0, Lcom/android/server/fingerprint/FingerprintService;->mLockoutMonitors:Ljava/util/ArrayList;

    invoke-static {}, Lcom/android/server/fingerprint/FingerprintUtils;->getInstance()Lcom/android/server/fingerprint/FingerprintUtils;

    move-result-object v5

    iput-object v5, p0, Lcom/android/server/fingerprint/FingerprintService;->mFingerprintUtils:Lcom/android/server/fingerprint/FingerprintUtils;

    new-instance v5, Lcom/android/server/fingerprint/FingerprintService$1;

    invoke-direct {v5, p0}, Lcom/android/server/fingerprint/FingerprintService$1;-><init>(Lcom/android/server/fingerprint/FingerprintService;)V

    iput-object v5, p0, Lcom/android/server/fingerprint/FingerprintService;->mLockoutReceiver:Landroid/content/BroadcastReceiver;

    new-instance v5, Lcom/android/server/fingerprint/FingerprintService$2;

    invoke-direct {v5, p0}, Lcom/android/server/fingerprint/FingerprintService$2;-><init>(Lcom/android/server/fingerprint/FingerprintService;)V

    iput-object v5, p0, Lcom/android/server/fingerprint/FingerprintService;->mResetFailedAttemptsRunnable:Ljava/lang/Runnable;

    new-instance v5, Lcom/android/server/fingerprint/FingerprintService$3;

    invoke-direct {v5, p0}, Lcom/android/server/fingerprint/FingerprintService$3;-><init>(Lcom/android/server/fingerprint/FingerprintService;)V

    iput-object v5, p0, Lcom/android/server/fingerprint/FingerprintService;->mDaemonCallback:Landroid/hardware/fingerprint/IFingerprintDaemonCallback;

    iput-object v9, p0, Lcom/android/server/fingerprint/FingerprintService;->mHandler:Landroid/os/Handler;

    iput-object v9, p0, Lcom/android/server/fingerprint/FingerprintService;->mTakePictureClient:Lcom/android/server/fingerprint/FingerprintService$ClientMonitor;
    ...
    iput-object v5, p0, Lcom/android/server/fingerprint/FingerprintService;->mKeyguardPackage:Ljava/lang/String;
    ...
    iput-object v5, p0, Lcom/android/server/fingerprint/FingerprintService;->mAppOps:Landroid/app/AppOpsManager;
    ...
    iput-object v5, p0, Lcom/android/server/fingerprint/FingerprintService;->mPowerManager:Landroid/os/PowerManager;
    ...
    iput-object v5, p0, Lcom/android/server/fingerprint/FingerprintService;->mAlarmManager:Landroid/app/AlarmManager;

    iget-object v5, p0, Lcom/android/server/fingerprint/FingerprintService;->mContext:Landroid/content/Context;

    iget-object v6, p0, Lcom/android/server/fingerprint/FingerprintService;->mLockoutReceiver:Landroid/content/BroadcastReceiver;

    new-instance v7, Landroid/content/IntentFilter;

    const-string v8, "com.android.server.fingerprint.ACTION_LOCKOUT_RESET"

    invoke-direct {v7, v8}, Landroid/content/IntentFilter;-><init>(Ljava/lang/String;)V

    const-string v8, "android.permission.RESET_FINGERPRINT_LOCKOUT"
    ...
    .local v2, "hthread":Landroid/os/HandlerThread;
    invoke-virtual {v2}, Landroid/os/HandlerThread;->start()V

    new-instance v5, Lcom/android/server/fingerprint/FingerprintService$FingerprintHandler;

    invoke-virtual {v2}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v6

    invoke-direct {v5, p0, v6}, Lcom/android/server/fingerprint/FingerprintService$FingerprintHandler;-><init>(Lcom/android/server/fingerprint/FingerprintService;Landroid/os/Looper;)V
    ...
    const-string v5, "com.android.server.fingerprint.FingerprintExtendImpl"

    invoke-static {v5}, Ljava/lang/Class;->forName(Ljava/lang/String;)Ljava/lang/Class;

    move-result-object v5

    iput-object v5, p0, Lcom/android/server/fingerprint/FingerprintService;->mFingerprintExtendClass:Ljava/lang/Class;

    iget-object v5, p0, Lcom/android/server/fingerprint/FingerprintService;->mFingerprintExtendClass:Ljava/lang/Class;
    ...
    check-cast v5, Lcom/android/server/fingerprint/FingerprintExtend;

    iput-object v5, p0, Lcom/android/server/fingerprint/FingerprintService;->mFingerprintExtend:Lcom/android/server/fingerprint/FingerprintExtend;
    :try_end_0
    ...
    :goto_0
    iget-object v5, p0, Lcom/android/server/fingerprint/FingerprintService;->mFingerprintExtend:Lcom/android/server/fingerprint/FingerprintExtend;

    if-nez v5, :cond_0

    const-string v5, "czy"

    const-string v6, "FingerprintExtend is null"
...
.method static synthetic access$2000(Lcom/android/server/fingerprint/FingerprintService;)V
    ...
    .prologue
    invoke-direct {p0}, Lcom/android/server/fingerprint/FingerprintService;->handleSyncDatabase()V

    return-void
.end method

.method static synthetic access$2100(Lcom/android/server/fingerprint/FingerprintService;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/fingerprint/FingerprintService;

    .prologue
    invoke-direct {p0}, Lcom/android/server/fingerprint/FingerprintService;->handleUpdateVersion()V

    return-void
.end method

.method static synthetic access$600(Lcom/android/server/fingerprint/FingerprintService;)Lcom/android/server/fingerprint/FingerprintService$ClientMonitor;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/fingerprint/FingerprintService;
...
.method private handleFailedAttempt(Lcom/android/server/fingerprint/FingerprintService$ClientMonitor;)Z
    ...
    iget-boolean v1, p1, Lcom/android/server/fingerprint/FingerprintService$ClientMonitor;->restricted:Z
...
.method private handleSyncDatabase()V
    .locals 4

    .prologue
    iget-object v1, p0, Lcom/android/server/fingerprint/FingerprintService;->mFingerprintExtend:Lcom/android/server/fingerprint/FingerprintExtend;
    ...
    const-string v2, "startAuthentication: no fingeprintd!"
    ...
    invoke-virtual {v1, v0, v2, v3}, Lcom/android/server/fingerprint/FingerprintExtend;->syncDatebase(Landroid/hardware/fingerprint/IFingerprintDaemon;Landroid/content/Context;I)V

    goto :goto_0
.end method

.method private handleUpdateVersion()V
    .locals 3
    ...
    invoke-virtual {v1}, Lcom/android/server/fingerprint/FingerprintExtend;->updateFingerVersion()V
...
.method disableFingerprint()V
    ...
    const-string v3, "disableFingerprint "
    ...
    const-string v3, "disableFingerprint: no fingeprintd!"
    ...
    const-string v4, "disableFingerprint result="
...
.method enableFingerprint()V
    ...
    const-string v3, "enableFingerprint "
    ...
    const-string v3, "enableFingerprint : no fingeprintd!"
    ...
    const-string v4, "enableFingerprint result="
...
.method getMaxEnrollFingerprints()I
    .locals 1
    ...
    invoke-virtual {v0}, Lcom/android/server/fingerprint/FingerprintExtend;->getMaxEnrollFingerprints()I
...
.method protected handleError(JI)V
    ...
    invoke-virtual {p0, v0, v2}, Lcom/android/server/fingerprint/FingerprintService;->stopTakePicture(Landroid/os/IBinder;Z)V
...
.method protected handleFidoAuthenticated(JII[B)V
    ...
    const-string v3, "handleAuthenticated, fingerId:"
    ...
    const-string v3, "handleAuthenticated, uvt:"
    ...
    # invokes: Lcom/android/server/fingerprint/FingerprintService$ClientMonitor;->sendFidoAuthenticated(II[B)Z
    invoke-static {v1, p3, p4, p5}, Lcom/android/server/fingerprint/FingerprintService$ClientMonitor;->access$2200(Lcom/android/server/fingerprint/FingerprintService$ClientMonitor;II[B)Z
...
.method setDefaultMode(I)V
    ...
    const-string v4, "setDefaultMode "
...
.method startAuthenticationFido(Landroid/os/IBinder;JILandroid/hardware/fingerprint/IFingerprintServiceReceiver;IZLjava/lang/String;[B[B)V
    .locals 10
    .param p1, "token"    # Landroid/os/IBinder;
    .param p2, "opId"    # J
    .param p4, "groupId"    # I
    ...
    const-string v1, "startAuthenticationFido "
    ...
    invoke-virtual/range {v0 .. v6}, Lcom/android/server/fingerprint/FingerprintExtend;->authenticateFido(Landroid/hardware/fingerprint/IFingerprintDaemon;JI[B[B)I
...
.method startTakePicture(Landroid/os/IBinder;ILandroid/hardware/fingerprint/IFingerprintServiceReceiver;Z)V
    ...
    const-string v1, "startTakePicture "
    ...
    invoke-virtual {v0, v7, p2}, Lcom/android/server/fingerprint/FingerprintExtend;->startTakePicture(Landroid/hardware/fingerprint/IFingerprintDaemon;I)I
    ...
    const-string v2, "startTakePicture result="
...
.method stopTakePicture(Landroid/os/IBinder;Z)V
    ...
    const-string v4, "stopTakePicture "
    ...
    # invokes: Lcom/android/server/fingerprint/FingerprintService$ClientMonitor;->sendError(I)Z
    invoke-static {v0, v3}, Lcom/android/server/fingerprint/FingerprintService$ClientMonitor;->access$200(Lcom/android/server/fingerprint/FingerprintService$ClientMonitor;I)Z
