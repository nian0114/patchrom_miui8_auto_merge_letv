...
.method public constructor <init>(Landroid/content/Context;Landroid/os/INetworkManagementService;Landroid/net/INetworkStatsService;Landroid/os/Looper;)V
    ...
    iput v5, p0, Lcom/android/server/connectivity/Tethering;->mClientNum:I
    ...
    const-string v2, "com.android.server.WifiManager.action.STOP_HOTSPOT"
...
.method static synthetic access$1000(Lcom/android/server/connectivity/Tethering;)Landroid/net/wifi/WifiManager;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/connectivity/Tethering;
...
.method static synthetic access$1100(Lcom/android/server/connectivity/Tethering;)Landroid/content/Context;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/connectivity/Tethering;
...
.method static synthetic access$2902(Lcom/android/server/connectivity/Tethering;I)I
    ...
    .prologue
    iput p1, p0, Lcom/android/server/connectivity/Tethering;->mClientNum:I
...
.method static synthetic access$3000(Lcom/android/server/connectivity/Tethering;)Landroid/app/PendingIntent;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/connectivity/Tethering;

    .prologue
    iget-object v0, p0, Lcom/android/server/connectivity/Tethering;->mIntentStopHotspot:Landroid/app/PendingIntent;

    return-object v0
.end method

.method static synthetic access$3100(Lcom/android/server/connectivity/Tethering;)Landroid/app/AlarmManager;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/connectivity/Tethering;
...
.method private clearTetheredNotification()V
    ...
    const-string v3, "clearTetheredNotification"
    ...
    const-string v5, "mLastNotificationId"

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget v5, p0, Lcom/android/server/connectivity/Tethering;->mLastNotificationId:I
...
.method private readDeviceInfoFromDnsmasq(Landroid/net/wifi/WifiDevice;)Z
    ...
    iget-object v11, p1, Landroid/net/wifi/WifiDevice;->deviceAddress:Ljava/lang/String;
    ...
    iput-object v7, p1, Landroid/net/wifi/WifiDevice;->deviceIp:Ljava/lang/String;

    iput-object v9, p1, Landroid/net/wifi/WifiDevice;->deviceName:Ljava/lang/String;
    :try_end_1
    ...
    const-string v13, "readDeviceNameFromDnsmasq: "
...
.method private showTetheredNotification(I)V
    ...
    const-string v3, "mLastNotificationId"
    ...
    const-string v3, "showTetheredNotification size="
    ...
    invoke-virtual {v11, v0, v1, v3, v4}, Landroid/app/StatusBarManager;->setIcon(Ljava/lang/String;IILjava/lang/String;)V
...
.method public interfaceMessageRecevied(Ljava/lang/String;)V
    ...
    iget v2, p0, Lcom/android/server/connectivity/Tethering;->mClientNum:I

    add-int/lit8 v2, v2, 0x1

    iput v2, p0, Lcom/android/server/connectivity/Tethering;->mClientNum:I
    ...
    iget-object v3, p0, Lcom/android/server/connectivity/Tethering;->mIntentStopHotspot:Landroid/app/PendingIntent;
    ...
    iget-object v6, p0, Lcom/android/server/connectivity/Tethering;->mIntentStopHotspot:Landroid/app/PendingIntent;
...
.method updateConfiguration()V
    ...
    invoke-static {v10, v11}, Landroid/telephony/SubscriptionManager;->getResourcesForSubId(Landroid/content/Context;I)Landroid/content/res/Resources;
    ...
    const-string v12, "wils.debug get Resource mcc:"
    ...
    iget v12, v12, Landroid/content/res/Configuration;->mcc:I
    ...
    const-string v12, "wils.debug get Resource mnc:"
    ...
    const-string v12, "wils.debug add iface:"
    ...
    .end local v4    # "len$":I
    .end local v8    # "tetherableWifiRegexs":[Ljava/lang/String;
    .end local v9    # "upstreamIfaceTypes":Ljava/util/Collection;, "Ljava/util/Collection<Ljava/lang/Integer;>;"
    :cond_1
    const v10, 0x1070011
    ...
    .restart local v8    # "tetherableWifiRegexs":[Ljava/lang/String;
    goto :goto_0
    ...
    .restart local v9    # "upstreamIfaceTypes":Ljava/util/Collection;, "Ljava/util/Collection<Ljava/lang/Integer;>;"
    :cond_2
