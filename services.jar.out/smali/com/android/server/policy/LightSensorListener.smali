...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput v1, p0, Lcom/android/server/policy/LightSensorListener;->mSample:F
...
.method static synthetic access$200(Lcom/android/server/policy/LightSensorListener;)F
    .locals 1
    .param p0, "x0"    # Lcom/android/server/policy/LightSensorListener;

    .prologue
    .line 27
    iget v0, p0, Lcom/android/server/policy/LightSensorListener;->mSample:F

    return v0
.end method

.method static synthetic access$300(Lcom/android/server/policy/LightSensorListener;)I
    .locals 1
    .param p0, "x0"    # Lcom/android/server/policy/LightSensorListener;
...
.method static synthetic access$400(Lcom/android/server/policy/LightSensorListener;Z)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/policy/LightSensorListener;
    .param p1, "x1"    # Z
...
.method public final onSensorChanged(Landroid/hardware/SensorEvent;)V
    ...
    .line 104
    iget v1, p0, Lcom/android/server/policy/LightSensorListener;->mSampleCount:I

    add-int/lit8 v1, v1, 0x1

    iput v1, p0, Lcom/android/server/policy/LightSensorListener;->mSampleCount:I

    iget v2, p0, Lcom/android/server/policy/LightSensorListener;->mSkipCount:I

    if-le v1, v2, :cond_1

    .line 105
    iget-object v1, p0, Lcom/android/server/policy/LightSensorListener;->mLock:Ljava/lang/Object;

    monitor-enter v1

    .line 106
    :try_start_0
    iget-object v2, p0, Lcom/android/server/policy/LightSensorListener;->mHandler:Landroid/os/Handler;

    iget-object v3, p0, Lcom/android/server/policy/LightSensorListener;->mRunnable:Ljava/lang/Runnable;
    ...
    .line 108
    iget v2, p0, Lcom/android/server/policy/LightSensorListener;->mSample:F
    ...
    :cond_0
    invoke-direct {p0, v0}, Lcom/android/server/policy/LightSensorListener;->setAdaptiveDisplay(Z)V
