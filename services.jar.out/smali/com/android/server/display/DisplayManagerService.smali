...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 152
    new-instance v0, Lcom/android/server/display/DisplayManagerService$DisplayModeLock;

    invoke-direct {v0}, Lcom/android/server/display/DisplayManagerService$DisplayModeLock;-><init>()V

    iput-object v0, p0, Lcom/android/server/display/DisplayManagerService;->mLock:Lcom/android/server/display/DisplayManagerService$DisplayModeLock;
    ...
    .line 251
    invoke-direct {p0}, Lcom/android/server/display/DisplayManagerService;->getDisplayBrightness()I
    ...
    .line 255
    const-string v0, "persist.sys.sf.lcd_density"

    sget v1, Lcom/android/server/display/DisplayManagerService;->mDefaultDisplayDensity:I
...
.method static synthetic access$1300(Lcom/android/server/display/DisplayManagerService;)Lcom/android/server/display/DisplayManagerService$DisplayModeLock;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/display/DisplayManagerService;
...
.method static synthetic access$1500(Lcom/android/server/display/DisplayManagerService;)Landroid/content/Context;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/display/DisplayManagerService;
...
.method static synthetic access$4100(Lcom/android/server/display/DisplayManagerService;IZ)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/display/DisplayManagerService;
    .param p1, "x1"    # I
    .param p2, "x2"    # Z
...
.method static synthetic access$4400(Lcom/android/server/display/DisplayManagerService;Landroid/hardware/display/DisplayManagerInternal$DisplayTransactionListener;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/display/DisplayManagerService;
    .param p1, "x1"    # Landroid/hardware/display/DisplayManagerInternal$DisplayTransactionListener;
...
.method static synthetic access$4500(Lcom/android/server/display/DisplayManagerService;ILandroid/view/DisplayInfo;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/display/DisplayManagerService;
    .param p1, "x1"    # I
...
.method static synthetic access$4700(Lcom/android/server/display/DisplayManagerService;IZFIZ)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/display/DisplayManagerService;
    .param p1, "x1"    # I
    .param p2, "x2"    # Z
...
.method static synthetic access$4800(Lcom/android/server/display/DisplayManagerService;III)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/display/DisplayManagerService;
    .param p1, "x1"    # I
    .param p2, "x2"    # I
...
.method private dumpInternal(Ljava/io/PrintWriter;)V
    ...
    const-string v12, "  mDisplayDensity="

    invoke-virtual {v10, v12}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v10

    sget v12, Lcom/android/server/display/DisplayManagerService;->mDisplayDensity:I
...
.method private getDisplayBrightness()I
    .locals 13
    ...
    .line 316
    .local v5, "useLeBacklightGammaCurve":Z
    iget-object v8, p0, Lcom/android/server/display/DisplayManagerService;->mContext:Landroid/content/Context;
    ...
    .line 320
    .local v4, "screenBrightnessSettingMinimum":I
    sget v8, Landroid/os/PowerManager;->BRIGHTNESS_ON:I

    invoke-static {v4, v10, v8}, Landroid/util/MathUtils;->constrain(III)I
    ...
    .line 324
    .local v0, "displayBrightness":I
    if-eqz v5, :cond_0

    if-ge v0, v4, :cond_1

    .line 331
    .end local v0    # "displayBrightness":I
    :cond_0
    :goto_0
    return v0

    .line 327
    .restart local v0    # "displayBrightness":I
    :cond_1
    new-array v6, v12, [F
    ...
    .line 329
    .local v7, "y":[F
    invoke-static {v6, v7}, Lcom/android/server/display/CurveFactory;->createGammaCurve([F[F)Lcom/android/server/display/GammaCurve;

    move-result-object v1

    .line 331
    .local v1, "gammaCurve":Lcom/android/server/display/Curve;
    int-to-float v8, v0

    invoke-interface {v1, v8}, Lcom/android/server/display/Curve;->transform(F)F
...
.method public getCurrentDisplayDensityInternal()I
    ...
    .line 676
    :try_start_0
    const-string v1, "persist.sys.sf.lcd_density"
