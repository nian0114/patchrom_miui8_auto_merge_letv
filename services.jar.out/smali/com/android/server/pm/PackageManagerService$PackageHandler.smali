...
.method doHandleMessage(Landroid/os/Message;)V
    ...
    const-string v6, "install state -----packageName is "
    ...
    iget-object v6, v0, Lcom/android/server/pm/PackageManagerService$PackageInstalledInfo;->name:Ljava/lang/String;

    invoke-virtual {v3, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    const-string v6, " returnCode is "
    ...
    iget-object v2, v2, Lcom/android/server/pm/PackageManagerService;->mInstallingStatePackage:Landroid/util/ArrayMap;
    ...
    const-string v6, "install state -----remove Installing State for "
    ...
    const-string v3, "install state -----remove Installing State name is null"
    ...
    const-string v3, "install state -----remove Installing State error for  res is null"
