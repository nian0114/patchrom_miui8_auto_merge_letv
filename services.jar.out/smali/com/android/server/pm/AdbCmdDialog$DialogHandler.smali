...
.method public handleMessage(Landroid/os/Message;)V
    ...
    # getter for: Lcom/android/server/pm/AdbCmdDialog;->mContext:Landroid/content/Context;
    invoke-static {v2}, Lcom/android/server/pm/AdbCmdDialog;->access$000(Lcom/android/server/pm/AdbCmdDialog;)Landroid/content/Context;
    ...
    # getter for: Lcom/android/server/pm/AdbCmdDialog;->mContext:Landroid/content/Context;
    invoke-static {v15}, Lcom/android/server/pm/AdbCmdDialog;->access$000(Lcom/android/server/pm/AdbCmdDialog;)Landroid/content/Context;
    ...
    # getter for: Lcom/android/server/pm/AdbCmdDialog;->installByAdb:Lcom/letv/leui/widget/LeBottomSheet;
    invoke-static {v2}, Lcom/android/server/pm/AdbCmdDialog;->access$100(Lcom/android/server/pm/AdbCmdDialog;)Lcom/letv/leui/widget/LeBottomSheet;
    ...
    # getter for: Lcom/android/server/pm/AdbCmdDialog;->mChoice:Lcom/letv/leui/widget/LeCheckBox;
    invoke-static {v2}, Lcom/android/server/pm/AdbCmdDialog;->access$200(Lcom/android/server/pm/AdbCmdDialog;)Lcom/letv/leui/widget/LeCheckBox;
    ...
    invoke-static {v2}, Lcom/android/server/pm/AdbCmdDialog;->access$300(Lcom/android/server/pm/AdbCmdDialog;)Lcom/android/server/pm/AdbCmdDialog$DialogHandler;
    ...
    # getter for: Lcom/android/server/pm/AdbCmdDialog;->mHandler:Lcom/android/server/pm/AdbCmdDialog$DialogHandler;
    invoke-static {v7}, Lcom/android/server/pm/AdbCmdDialog;->access$300(Lcom/android/server/pm/AdbCmdDialog;)Lcom/android/server/pm/AdbCmdDialog$DialogHandler;
    ...
    # getter for: Lcom/android/server/pm/AdbCmdDialog;->acr:Lcom/android/server/pm/AdbCmdResult;
    invoke-static {v2}, Lcom/android/server/pm/AdbCmdDialog;->access$500(Lcom/android/server/pm/AdbCmdDialog;)Lcom/android/server/pm/AdbCmdResult;
    ...
    # getter for: Lcom/android/server/pm/AdbCmdDialog;->result:Z
    invoke-static {v7}, Lcom/android/server/pm/AdbCmdDialog;->access$400(Lcom/android/server/pm/AdbCmdDialog;)Z
    ...
    const-string v7, "leui_install_dialog_always_ask"
    ...
    const-string v15, " adbDialog : alwayAsk is :"
    ...
    const-string v15, "leui_allow_adb_install"
    ...
    # getter for: Lcom/android/server/pm/AdbCmdDialog;->result:Z
    invoke-static {v2}, Lcom/android/server/pm/AdbCmdDialog;->access$400(Lcom/android/server/pm/AdbCmdDialog;)Z
