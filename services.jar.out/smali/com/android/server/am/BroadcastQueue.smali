...
.field private final mSourcePkgs:[Ljava/lang/String;
...
.field private final mTargetPkgs:[Ljava/lang/String;
...
.method constructor <init>(Lcom/android/server/am/ActivityManagerService;Landroid/os/Handler;Ljava/lang/String;JZ)V
    ...
    iput-object v0, p0, Lcom/android/server/am/BroadcastQueue;->mSourcePkgs:[Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/android/server/am/BroadcastQueue;->mTargetPkgs:[Ljava/lang/String;
...
.method private isAllowSend(Lcom/android/server/am/BroadcastRecord;Landroid/content/pm/ResolveInfo;)Z
    .locals 13
    .param p1, "r"    # Lcom/android/server/am/BroadcastRecord;
    ...
    .line 1592
    .local v9, "limit":Z
    invoke-direct {p0, p1, p2}, Lcom/android/server/am/BroadcastQueue;->isNeedCheck(Lcom/android/server/am/BroadcastRecord;Landroid/content/pm/ResolveInfo;)Z

    move-result v7

    .line 1594
    .local v7, "isNeedCheck":Z
    if-eqz v7, :cond_3
    ...
    .line 1596
    .local v5, "infoUid":I
    iget-object v10, p1, Lcom/android/server/am/BroadcastRecord;->curReceiver:Landroid/content/pm/ActivityInfo;
    ...
    .line 1598
    .local v4, "infoPkg":Ljava/lang/String;
    ...
    invoke-virtual {v10, v11, v5, v4}, Lcom/android/server/AppOpsService;->checkOperation(IILjava/lang/String;)I
    ...
    const-string v12, ", r.callingUid = "

    invoke-virtual {v11, v12}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v11

    iget v12, p1, Lcom/android/server/am/BroadcastRecord;->callingUid:I

    invoke-virtual {v11, v12}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v11

    const-string v12, ", r.callingPid = "

    invoke-virtual {v11, v12}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v11

    iget v12, p1, Lcom/android/server/am/BroadcastRecord;->callingPid:I

    invoke-virtual {v11, v12}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v11

    const-string v12, ", r.callerApp = "

    invoke-virtual {v11, v12}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v11

    iget-object v12, p1, Lcom/android/server/am/BroadcastRecord;->callerApp:Lcom/android/server/am/ProcessRecord;
    ...
    iget v10, p1, Lcom/android/server/am/BroadcastRecord;->callingPid:I
    ...
    iget v10, p1, Lcom/android/server/am/BroadcastRecord;->callingUid:I
    ...
    invoke-virtual {v10, v4}, Lcom/android/server/am/ActivityManagerService;->isAlarmWhiteApp(Ljava/lang/String;)Z
    ...
    .line 1612
    .local v6, "isFromAlarmMS":Z
    :goto_0
    iget-object v10, p0, Lcom/android/server/am/BroadcastQueue;->mService:Lcom/android/server/am/ActivityManagerService;

    const/4 v11, 0x0

    invoke-virtual {v10, v4, v11}, Lcom/android/server/am/ActivityManagerService;->hasAppStarted(Ljava/lang/String;Ljava/lang/String;)Z

    move-result v3

    .line 1613
    .local v3, "hasAppStarted":Z
    const-string v10, "BroadcastQueue"
    ...
    const-string v12, "isWidgetAction = "
    ...
    const-string v12, ", isFromAlarmMS = "
    ...
    const-string v12, ", hasAppStarted = "
    ...
    .line 1617
    .end local v3    # "hasAppStarted":Z
    .end local v6    # "isFromAlarmMS":Z
    ...
    .end local v4    # "infoPkg":Ljava/lang/String;
    .end local v5    # "infoUid":I
    :cond_3
    :goto_1
    return v9
    ...
    .restart local v4    # "infoPkg":Ljava/lang/String;
    .restart local v5    # "infoUid":I
    .restart local v8    # "isWidgetAction":Z
    :cond_4
    const/4 v6, 0x0
...
.method private isNeedCheck(Lcom/android/server/am/BroadcastRecord;Landroid/content/pm/ResolveInfo;)Z
    .locals 10
    .param p1, "r"    # Lcom/android/server/am/BroadcastRecord;
    .param p2, "info"    # Landroid/content/pm/ResolveInfo;
    ...
    iget-object v7, p0, Lcom/android/server/am/BroadcastQueue;->mSourcePkgs:[Ljava/lang/String;
    ...
    invoke-static {v7, v3}, Lcom/android/internal/util/ArrayUtils;->contains([Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    const-string v9, "isNeedCheck: sourcePkg = "
    ...
    iget-object v7, p0, Lcom/android/server/am/BroadcastQueue;->mTargetPkgs:[Ljava/lang/String;
    ...
    .line 1587
    .end local v4    # "targetPkg":Ljava/lang/String;
    :cond_1
    :goto_0
    return v5

    .line 1574
    .restart local v4    # "targetPkg":Ljava/lang/String;
    :cond_2
    iget-object v7, p2, Landroid/content/pm/ResolveInfo;->activityInfo:Landroid/content/pm/ActivityInfo;
    ...
    const-string v9, "isNeedCheck: hasSystemFlag = "
    ...
    .end local v0    # "hasExOpFlag":Z
    .end local v1    # "hasSystemFlag":Z
    .end local v2    # "infoUid":I
    :cond_5
    move v1, v6
    ...
    .restart local v1    # "hasSystemFlag":Z
    :cond_6
    move v0, v6
...
.method final processNextBroadcast(Z)V
    ...
    .line 1044
    .local v43, "targetProcess":Ljava/lang/String;
    move-object/from16 v0, v18
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/server/am/BroadcastQueue;->isAllowSend(Lcom/android/server/am/BroadcastRecord;Landroid/content/pm/ResolveInfo;)Z
