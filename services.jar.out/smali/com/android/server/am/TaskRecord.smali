...
.field public static final TASK_THUMBNAIL_VIVID:I
...
.field public pendingCheckAccess:Z
...
.method private constructor <init>(Lcom/android/server/am/ActivityManagerService;ILandroid/content/Intent;Landroid/content/Intent;Ljava/lang/String;Ljava/lang/String;Landroid/content/ComponentName;Landroid/content/ComponentName;ZZZIIILjava/lang/String;Ljava/util/ArrayList;JJJZLandroid/app/ActivityManager$TaskDescription;IIIIILjava/lang/String;ZZ)V
    ...
    iput-boolean v2, p0, Lcom/android/server/am/TaskRecord;->checkAccessing:Z

    const/4 v2, 0x0

    iput-object v2, p0, Lcom/android/server/am/TaskRecord;->accessPkgName:Ljava/lang/String;

    const/4 v2, -0x1

    iput v2, p0, Lcom/android/server/am/TaskRecord;->thumbnailState:I

    const/4 v2, 0x0

    iput-boolean v2, p0, Lcom/android/server/am/TaskRecord;->needCheckAccess:Z

    const/4 v2, 0x0

    iput-boolean v2, p0, Lcom/android/server/am/TaskRecord;->pendingCheckAccess:Z
...
.method constructor <init>(Lcom/android/server/am/ActivityManagerService;ILandroid/content/pm/ActivityInfo;Landroid/content/Intent;Landroid/app/ActivityManager$TaskDescription;)V
    ...
    iput-boolean v3, p0, Lcom/android/server/am/TaskRecord;->checkAccessing:Z

    iput-object v5, p0, Lcom/android/server/am/TaskRecord;->accessPkgName:Ljava/lang/String;

    iput v2, p0, Lcom/android/server/am/TaskRecord;->thumbnailState:I

    iput-boolean v3, p0, Lcom/android/server/am/TaskRecord;->needCheckAccess:Z

    iput-boolean v3, p0, Lcom/android/server/am/TaskRecord;->pendingCheckAccess:Z
...
.method constructor <init>(Lcom/android/server/am/ActivityManagerService;ILandroid/content/pm/ActivityInfo;Landroid/content/Intent;Landroid/service/voice/IVoiceInteractionSession;Lcom/android/internal/app/IVoiceInteractor;)V
    ...
    iput-object v0, p0, Lcom/android/server/am/TaskRecord;->accessPkgName:Ljava/lang/String;

    iput v3, p0, Lcom/android/server/am/TaskRecord;->thumbnailState:I
...
.method static restoreFromXml(Lorg/xmlpull/v1/XmlPullParser;Lcom/android/server/am/ActivityStackSupervisor;)Lcom/android/server/am/TaskRecord;
    ...
    const-string v50, "TaskRecord: attribute name="
    ...
    const-string v50, "TaskRecord: START_TAG name="
    ...
    const-string v50, "TaskRecord: activity="
...
.method private setIntent(Landroid/content/Intent;Landroid/content/pm/ActivityInfo;)V
    ...
    iget-object v4, p2, Landroid/content/pm/ActivityInfo;->mAccessCtrlInfo:Landroid/content/pm/ActivityInfo$AccessControlInfo;

    if-eqz v4, :cond_6

    iget-object v4, p2, Landroid/content/pm/ActivityInfo;->mAccessCtrlInfo:Landroid/content/pm/ActivityInfo$AccessControlInfo;

    iget-object v4, v4, Landroid/content/pm/ActivityInfo$AccessControlInfo;->pkgName:Ljava/lang/String;

    iput-object v4, p0, Lcom/android/server/am/TaskRecord;->accessPkgName:Ljava/lang/String;

    new-instance v4, Landroid/content/Intent;

    iget-object v5, p2, Landroid/content/pm/ActivityInfo;->mAccessCtrlInfo:Landroid/content/pm/ActivityInfo$AccessControlInfo;

    iget-object v5, v5, Landroid/content/pm/ActivityInfo$AccessControlInfo;->targetIntent:Landroid/content/Intent;
...
.method static thumbnailStateToString(I)Ljava/lang/String;
    .locals 1
    .param p0, "state"    # I
    ...
    const-string v0, "TASK_THUMBNAIL_UNKNOW"

    :goto_0
    return-object v0

    :pswitch_0
    const-string v0, "TASK_THUMBNAIL_VIVID"

    goto :goto_0

    :pswitch_1
    const-string v0, "TASK_THUMNAIL_MOSAIC"

    goto :goto_0

    :pswitch_2
    const-string v0, "TASK_THUMBNAIL_INVALID"
...
.method addActivityAtIndex(ILcom/android/server/am/ActivityRecord;)V
    ...
    :cond_1
    iget-object v0, p2, Lcom/android/server/am/ActivityRecord;->accessPkgName:Ljava/lang/String;

    if-eqz v0, :cond_2

    iget-boolean v0, p0, Lcom/android/server/am/TaskRecord;->checkAccessing:Z
    ...
    const-string v2, "checkAccessing end addActivityAdIndex r="
...
.method dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    const-string v0, "needCheckAccess="

    invoke-virtual {p1, v0}, Ljava/io/PrintWriter;->print(Ljava/lang/String;)V

    iget-boolean v0, p0, Lcom/android/server/am/TaskRecord;->needCheckAccess:Z
    ...
    iget v0, p0, Lcom/android/server/am/TaskRecord;->thumbnailState:I

    invoke-static {v0}, Lcom/android/server/am/TaskRecord;->thumbnailStateToString(I)Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p1, v0}, Ljava/io/PrintWriter;->print(Ljava/lang/String;)V

    const-string v0, " pendingCheckAccess="

    invoke-virtual {p1, v0}, Ljava/io/PrintWriter;->print(Ljava/lang/String;)V

    iget-boolean v0, p0, Lcom/android/server/am/TaskRecord;->pendingCheckAccess:Z
...
.method freeLastThumbnail()V
    ...
    const-string v1, "Skip Home task to freeLastThumbnail"
...
.method isAccessControlTask()Z
    .locals 1

    .prologue
    iget-object v0, p0, Lcom/android/server/am/TaskRecord;->accessPkgName:Ljava/lang/String;
...
.method setLastThumbnail(Landroid/graphics/Bitmap;)Z
    ...
    invoke-virtual {v1, p1, v2, v0}, Lcom/android/server/am/TaskPersister;->saveImage(Landroid/graphics/Bitmap;Ljava/lang/String;Z)V
    ...
    const-string v1, "Ignore Home Task to save"
...
.method public toString()Ljava/lang/String;
    ...
    const-string v1, " taskToReturnTo="
