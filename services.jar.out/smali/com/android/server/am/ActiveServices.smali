...
.method public constructor <init>(Lcom/android/server/am/ActivityManagerService;)V
    ...
    const-string v4, "android.accounts.cts.unaffiliated"
    ...
    const-string v5, "com.tencent.android.tpush.service.XGPushService"

    aput-object v5, v3, v4

    const/4 v4, 0x3

    const-string v5, "com.alibaba.sdk.android.push.ChannelService"
    ...
    const-string v5, "com.baidu.sapi2.share.ShareService"
...
.method private final bringUpServiceLocked(Lcom/android/server/am/ServiceRecord;IZZ)Ljava/lang/String;
    ...
    iget-boolean v2, v0, Lcom/android/server/am/ServiceRecord;->isShadow:Z
    ...
    sget-boolean v2, Lcom/android/server/am/ActivityManagerDebugConfig;->DEBUG_DOUBLE_APP:Z
    ...
    const-string v5, "double app getProcess app:"
...
.method private isSkipPackageName(Ljava/lang/String;)Z
    ...
    iget-object v4, p0, Lcom/android/server/am/ActiveServices;->mSkipPackageNames:[Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/android/server/am/ActiveServices;->mSkipPackageNames:[Ljava/lang/String;
...
.method private retrieveServiceLocked(Landroid/content/Intent;Ljava/lang/String;Ljava/lang/String;IIIZZ)Lcom/android/server/am/ActiveServices$ServiceLookupResult;
    ...
    const-string v8, "retrieveServiceLocked: "
    ...
    .local v23, "isShadow":Z
    const-string v3, ".LetvClone"
    ...
    invoke-interface {v3, v0}, Landroid/content/pm/IPackageManager;->isAppDouble(Ljava/lang/String;)Z

    move-result v22

    .local v22, "isDouble":Z
    if-eqz v22, :cond_1

    const/16 v23, 0x1

    :cond_1
    sget-boolean v3, Lcom/android/server/am/ActivityManagerDebugConfig;->DEBUG_DOUBLE_APP:Z
    ...
    const-string v8, "double app. retrieveServiceLocked Provider isDouble;"
    ...
    iget-object v3, v0, Lcom/android/server/am/ActiveServices$ServiceMap;->mShadowServicesByName:Landroid/util/ArrayMap;
    ...
    iget-object v3, v0, Lcom/android/server/am/ActiveServices$ServiceMap;->mShadowServicesByIntent:Landroid/util/ArrayMap;
    ...
    const-string v8, "double app. retrieveServiceLocked service intent hasCategory, but comp is null!!!, callingPid;"
    ...
    const-string v8, "don\'t allow to start "
    ...
    iget-object v8, v4, Landroid/content/pm/ServiceInfo;->applicationInfo:Landroid/content/pm/ApplicationInfo;

    iget-object v10, v4, Landroid/content/pm/ServiceInfo;->name:Ljava/lang/String;

    iget v11, v4, Landroid/content/pm/ServiceInfo;->flags:I

    invoke-virtual {v3, v6, v8, v10, v11}, Lcom/android/server/am/ActivityManagerService;->isSingleton(Ljava/lang/String;Landroid/content/pm/ApplicationInfo;Ljava/lang/String;I)Z
    ...
    :cond_8
    new-instance v30, Landroid/content/pm/ServiceInfo;
    ...
    invoke-direct {v12, v0, v3}, Lcom/android/server/am/ActiveServices$ServiceRestarter;-><init>(Lcom/android/server/am/ActiveServices;Lcom/android/server/am/ActiveServices$1;)V
    ...
    invoke-virtual {v0, v3, v6, v8}, Lcom/android/internal/os/BatteryStatsImpl;->getServiceStatsLocked(ILjava/lang/String;Ljava/lang/String;)Lcom/android/internal/os/BatteryStatsImpl$Uid$Pkg$Serv;
    ...
    const-string v8, "double app retrieveServiceLocked put clone servicesMap sInfo.name: "
    ...
    iget-boolean v3, v0, Lcom/android/server/am/ServiceRecord;->isShadow:Z
    ...
    iget v8, v8, Landroid/content/pm/ApplicationInfo;->uidOffset:I
    ...
    iget-object v8, v5, Lcom/android/server/am/ServiceRecord;->appInfo:Landroid/content/pm/ApplicationInfo;
    ...
    const-string v10, "not exported from uid "
    ...
    invoke-direct {v3, v0, v6, v8}, Lcom/android/server/am/ActiveServices$ServiceLookupResult;-><init>(Lcom/android/server/am/ActiveServices;Lcom/android/server/am/ServiceRecord;Ljava/lang/String;)V
    ...
    iget-object v8, v5, Lcom/android/server/am/ServiceRecord;->serviceInfo:Landroid/content/pm/ServiceInfo;
...
.method attachApplicationLocked(Lcom/android/server/am/ProcessRecord;Ljava/lang/String;)Z
    ...
    const-string v7, "xulei check attachApplicationLocked proc: "
    ...
    const-string v7, "xulei check attachApplicationLocked 123 proc: "
...
.method bindServiceLocked(Landroid/app/IApplicationThread;Landroid/os/IBinder;Landroid/content/Intent;Ljava/lang/String;Landroid/app/IServiceConnection;ILjava/lang/String;I)I
    ...
    const-string v6, "double app  bindServiceLocked service:"
...
.method cleanUpRemovedTaskLocked(Lcom/android/server/am/TaskRecord;Landroid/content/ComponentName;Landroid/content/Intent;)V
    ...
    :goto_0
    invoke-virtual {p1}, Lcom/android/server/am/TaskRecord;->isAccessControlTask()Z
...
.method getServiceByName(Landroid/content/ComponentName;I)Lcom/android/server/am/ServiceRecord;
    ...
    const-string v5, "getServiceByName("
    ...
    invoke-virtual {v3, v2}, Lcom/android/server/am/ActivityManagerService;->isCloneProcessByPid(I)Z
    ...
    iget-object v3, v3, Lcom/android/server/am/ActiveServices$ServiceMap;->mShadowServicesByName:Landroid/util/ArrayMap;
...
.method isAllowAutoStart(Landroid/content/pm/ComponentInfo;Landroid/content/Intent;III)Z
    ...
    .local v8, "hasSystemFlag":Z
    :goto_0
    sget-boolean v9, Lcom/android/server/am/ActivityManagerDebugConfig;->DEBUG_SERVICE:Z

    if-nez v9, :cond_0

    sget-boolean v9, Lcom/android/server/am/ActivityManagerDebugConfig;->DEBUG_PROVIDER:Z
    ...
    const-string v13, ", hasSystemFlag = "
    ...
    invoke-static {v9, v12, v13}, Landroid/util/Slog;->w(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I

    :cond_1
    invoke-direct {p0, v5}, Lcom/android/server/am/ActiveServices;->isSkipPackageName(Ljava/lang/String;)Z
    ...
    .end local v8    # "hasSystemFlag":Z
    :cond_2
    const/4 v8, 0x0

    goto :goto_0

    .restart local v8    # "hasSystemFlag":Z
    :cond_3
    :try_start_0
    invoke-static {}, Landroid/app/AppGlobals;->getPackageManager()Landroid/content/pm/IPackageManager;
    ...
    const-string v12, "com.letv.leui.cta"

    invoke-interface {v9, v12}, Landroid/content/pm/IPackageManager;->hasSystemFeature(Ljava/lang/String;)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v12, "allow to start cpm from itself."
    ...
    invoke-virtual {v9, v5, v4}, Lcom/android/server/am/ActivityManagerService;->hasAppStarted(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string v13, "don\'t allow to start, action = "
    ...
    const-string v12, "allow to start cpm from system."
    ...
    const-string v12, "allow to start cpm from system app."
    ...
    const-string v12, "allow to start cpm if its process exists."
    ...
    invoke-virtual {p0, v9}, Lcom/android/server/am/ActiveServices;->isAssociationComp(Ljava/lang/String;)Z
    ...
    const-string v12, "don\'t allow start association comp."
    ...
    invoke-virtual {v9, v5}, Lcom/android/server/am/ActivityManagerService;->hasRanCtsOrCta(Ljava/lang/String;)Z
    ...
    const-string v12, "allow to start cpm from top activity."
    ...
    invoke-virtual {v9, v12, v6, v5}, Lcom/android/server/AppOpsService;->checkOperation(IILjava/lang/String;)I
    ...
    const-string v12, "don\'t allow to start cpm."
    ...
    const-string v12, "allow to start cpm for other situations."
    ...
    const-string v13, " check operation error."
...
.method isAssociationComp(Ljava/lang/String;)Z
    .locals 7
    ...
    iget-object v4, p0, Lcom/android/server/am/ActiveServices;->mAssociationComps:[Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/android/server/am/ActiveServices;->mAssociationComps:[Ljava/lang/String;
    ...
    const-string v6, "isAssociationComp: "
    ...
    const-string v6, " is an association component."
...
.method final killServicesLocked(Lcom/android/server/am/ProcessRecord;Z)V
    ...
    const-string v21, "xulei check killServicesLocked  proc: "
    ...
    const-string v21, "xulei check killServicesLocked 123 app: "
...
.method processStartTimedOutLocked(Lcom/android/server/am/ProcessRecord;)V
    ...
    const-string v4, "xulei check processStartTimedOutLocked 123 proc: "
...
.method startServiceLocked(Landroid/app/IApplicationThread;Landroid/content/Intent;Ljava/lang/String;IILjava/lang/String;I)Landroid/content/ComponentName;
    ...
    const-string v4, "Double app  startServiceLocked  clone service:"
    ...
    invoke-virtual {v0, v1}, Landroid/content/Intent;->setCallingUid(I)Landroid/content/Intent;
    ...
    const-string v4, "double app getProcess proc:"
