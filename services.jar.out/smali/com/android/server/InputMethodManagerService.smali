...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/wm/WindowManagerService;)V
    ...
    .line 505
    new-instance v2, Lcom/android/server/InputMethodManagerService$KeyboardDetect;

    move-object/from16 v0, p0

    invoke-direct {v2, v0}, Lcom/android/server/InputMethodManagerService$KeyboardDetect;-><init>(Lcom/android/server/InputMethodManagerService;)V

    move-object/from16 v0, p0

    iput-object v2, v0, Lcom/android/server/InputMethodManagerService;->kb:Lcom/android/server/InputMethodManagerService$KeyboardDetect;
    ...
    const-string v4, "Initial default ime = "
...
.method static synthetic access$600(Lcom/android/server/InputMethodManagerService;)Lcom/letv/leui/widget/LePopupWindow;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/InputMethodManagerService;
...
.method private chooseNewDefaultIMELocked()Z
    ...
    .line 3077
    const-string v8, "ro.mtk_default_ime"
    ...
    .line 3078
    .local v4, "preInstalledImeName":Ljava/lang/String;
    const/4 v5, 0x0

    .line 3079
    .local v5, "preInstalledImi":Landroid/view/inputmethod/InputMethodInfo;
    ...
    .line 3081
    .local v3, "iminfo":Landroid/view/inputmethod/InputMethodInfo;
    ...
    .line 3086
    .end local v3    # "iminfo":Landroid/view/inputmethod/InputMethodInfo;
    :cond_1
    if-eqz v5, :cond_2
    ...
    invoke-virtual {p0, v8, v9}, Lcom/android/server/InputMethodManagerService;->setInputMethodLocked(Ljava/lang/String;I)V
    ...
    const-string v10, "New default IME was selected: "
    ...
    const-string v10, ",but it is auxiliary,so change to "
    ...
    .end local v4    # "preInstalledImeName":Ljava/lang/String;
    .end local v5    # "preInstalledImi":Landroid/view/inputmethod/InputMethodInfo;
    :goto_0
    return v7
    ...
    invoke-direct {p0, v8}, Lcom/android/server/InputMethodManagerService;->resetSelectedInputMethodAndSubtypeLocked(Ljava/lang/String;)V
    ...
    .line 3105
    .local v6, "tempImi":Landroid/view/inputmethod/InputMethodInfo;
    ...
    const-string v10, "chooseNewDefaultIMELocked mostApplicableDefaultIME is null, so enable one system IME and set new default IME : "
    ...
    invoke-virtual {p0, v8, v7}, Lcom/android/server/InputMethodManagerService;->setInputMethodEnabledLocked(Ljava/lang/String;Z)Z
    ...
    .line 3115
    .end local v6    # "tempImi":Landroid/view/inputmethod/InputMethodInfo;
    :cond_6
    const/4 v7, 0x0
...
.method private initAgnes(Landroid/content/Context;)Lcom/letv/tracker/agnes/App;
    ...
    const-string v3, "IMMS------init imms agnes"
...
.method private printUsage(Ljava/io/PrintWriter;)V
    ...
    .line 4127
    const-string v0, "         3 : InputMethodUtils"
...
.method private reportCurrentInputMethod()V
    ...
    const-string v5, "language_input"
    ...
    const-string v5, "IMMS appAgnes report ok!"
    ...
    const-string v5, "IMMS appAgnes is NULL"
    ...
    const-string v6, "IMMS appAgnes report error! e="
...
.method private resetDefaultImeLocked(Landroid/content/Context;)V
    ...
    const-string v5, " is valid system default ime, so we don\'t change it."
    ...
    const-string v4, "Bump mCurUserActionNotificationSequenceNumber:"
    ...
    invoke-virtual {v2, v4, v5, v8}, Lcom/android/internal/os/HandlerCaller;->obtainMessageIO(IILjava/lang/Object;)Landroid/os/Message;
    ...
    invoke-virtual {v1, v9}, Lcom/android/internal/inputmethod/InputMethodUtils$InputMethodSettings;->putSelectedSubtype(I)V
    ...
    .line 1114
    invoke-direct {p0, v6, v9, v4}, Lcom/android/server/InputMethodManagerService;->setSelectedInputMethodAndSubtypeLocked(Landroid/view/inputmethod/InputMethodInfo;IZ)V
...
.method static restoreEnabledInputMethods(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v8, "Restoring enabled input methods:"
    ...
    const-string v8, "Merged IME string:"
...
.method private runDebug(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;Z)V
    ...
    .line 4173
    sput-boolean p3, Lcom/android/internal/inputmethod/InputMethodUtils;->DEBUG:Z
    ...
    const-string v3, "InputMethodUtils DEBUG is turn "
...
.method private showInputMethodMenu(Z)V
    ...
    const-string v31, "InputMethodManagerService"

    new-instance v32, Ljava/lang/StringBuilder;

    invoke-direct/range {v32 .. v32}, Ljava/lang/StringBuilder;-><init>()V

    const-string v33, "Show switching menu. showAuxSubtypes="
    ...
    invoke-virtual/range {v31 .. v31}, Lcom/android/internal/inputmethod/InputMethodUtils$InputMethodSettings;->getSelectedInputMethod()Ljava/lang/String;
    ...
    .line 3283
    .local v29, "themedContext":Landroid/content/Context;
    new-instance v31, Lcom/letv/leui/widget/LePopupWindow$Builder;
    ...
    .line 3300
    .local v30, "tv":Landroid/view/View;
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v31 .. v31}, Lcom/android/server/wm/WindowManagerService;->isHardKeyboardAvailable()Z
    ...
    .line 3319
    new-instance v31, Lcom/android/server/InputMethodManagerService$8;
    ...
    .line 3335
    .local v28, "subtypeName":Ljava/lang/CharSequence;
    ...
    .end local v28    # "subtypeName":Ljava/lang/CharSequence;
    :cond_9
    const/16 v31, 0x8
    ...
    .restart local v28    # "subtypeName":Ljava/lang/CharSequence;
    :cond_a
    move-object/from16 v0, v23
    ...
    .end local v23    # "listitem":Lcom/letv/leui/widget/LePopupWindowAdapter$ItemData;
    .end local v28    # "subtypeName":Ljava/lang/CharSequence;
    .end local v29    # "themedContext":Landroid/content/Context;
    .end local v30    # "tv":Landroid/view/View;
    :catchall_0
    move-exception v31
    ...
    .restart local v23    # "listitem":Lcom/letv/leui/widget/LePopupWindowAdapter$ItemData;
    .restart local v28    # "subtypeName":Ljava/lang/CharSequence;
    .restart local v29    # "themedContext":Landroid/content/Context;
    .restart local v30    # "tv":Landroid/view/View;
    :cond_b
    const/16 v31, 0x0
    ...
    .line 3368
    .local v24, "multiChoiceClickListener":Landroid/content/DialogInterface$OnMultiChoiceClickListener;
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v31 .. v31}, Lcom/letv/leui/widget/LePopupWindow$Builder;->setSingleChoiceOn()Lcom/letv/leui/widget/LePopupWindow$Builder;
    ...
    .line 3378
    .local v26, "positiveListener":Landroid/content/DialogInterface$OnClickListener;
    move-object/from16 v0, p0
    ...
    .line 3381
    .end local v26    # "positiveListener":Landroid/content/DialogInterface$OnClickListener;
    :cond_d
    ...
    invoke-virtual/range {v31 .. v31}, Lcom/letv/leui/widget/LePopupWindow$Builder;->createBottom()Lcom/letv/leui/widget/LePopupWindow;
    ...
    invoke-virtual/range {v31 .. v31}, Lcom/letv/leui/widget/LePopupWindow;->getWindow()Landroid/view/Window;
    ...
    invoke-virtual/range {v31 .. v31}, Lcom/letv/leui/widget/LePopupWindow;->show()V
    ...
    invoke-static/range {v33 .. v35}, Landroid/graphics/Color;->rgb(III)I
...
.method private updateSystemUiLocked(Landroid/os/IBinder;II)V
    ...
    const-string v13, "need_show_input_method_switch_notification"
    ...
    const-string v14, "InputMethodManagerService setImeWindowStatus letvDefineNeedShow is:"
    ...
    const-string v14, "--- show notification: label =  "
...
.method buildInputMethodListLocked(Ljava/util/ArrayList;Ljava/util/HashMap;Z)V
    ...
    const-string v19, " InputMethod services. currentUser is "
...
.method public handleMessage(Landroid/os/Message;)Z
    ...
    const-string v13, ".showSoftInput("
    ...
    const-string v13, ".hideSoftInput(0, "
    ...
    const-string v13, "Sending attach of token: "
...
.method hideCurrentInputLocked(ILandroid/os/ResultReceiver;)Z
    ...
    const-string v3, "Keyboard hidden by explicitly"
    ...
    const-string v3, "Keyboard hidden by implicitly"
...
.method showCurrentInputLocked(ILandroid/os/ResultReceiver;)Z
    ...
    const-string v2, "Keyboard in foreground"
