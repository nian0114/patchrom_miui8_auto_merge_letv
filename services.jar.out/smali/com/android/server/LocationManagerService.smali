...
.method static synthetic access$1100(Lcom/android/server/LocationManagerService;Landroid/content/Intent;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/LocationManagerService;
...
.method static synthetic access$1200(Lcom/android/server/LocationManagerService;Landroid/content/Intent;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/LocationManagerService;
    .param p1, "x1"    # Landroid/content/Intent;
...
.method static synthetic access$1700(Lcom/android/server/LocationManagerService;)Landroid/app/AppOpsManager;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/LocationManagerService;
...
.method static synthetic access$1800(Lcom/android/server/LocationManagerService;)Lcom/android/server/LocationManagerService$LocationWorkerHandler;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/LocationManagerService;
...
.method static synthetic access$2300(Lcom/android/server/LocationManagerService;)Lcom/android/server/location/LocationRequestStatistics;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/LocationManagerService;
...
.method static synthetic access$700(Lcom/android/server/LocationManagerService;I)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/LocationManagerService;
    .param p1, "x1"    # I
...
.method static synthetic access$800(Lcom/android/server/LocationManagerService;)I
    .locals 1
    .param p0, "x0"    # Lcom/android/server/LocationManagerService;
...
.method private doPhoneStateChanged()V
    ...
    const-string v4, "doPhoneStateChanged sim mcc="
...
.method private doSimStateChanged(Landroid/content/Intent;)V
    ...
    const-string v5, "doSimStateChangedstatus="
    ...
    const-string v5, "doSimStateChanged sim mcc="
...
.method public locationCallbackFinished(Landroid/location/ILocationListener;)V
    ...
    invoke-static {v1}, Lcom/android/server/LocationManagerService$Receiver;->access$2100(Lcom/android/server/LocationManagerService$Receiver;)V
...
.method public systemRunning()V
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/server/LocationManagerService$LocationWorkerHandler;-><init>(Lcom/android/server/LocationManagerService;Landroid/os/Looper;)V
    ...
    new-instance v10, Lcom/android/server/LocationManagerService$2;

    invoke-direct {v10, p0}, Lcom/android/server/LocationManagerService$2;-><init>(Lcom/android/server/LocationManagerService;)V
    ...
    invoke-virtual {v0, v1, v2, v10}, Landroid/app/AppOpsManager;->startWatchingMode(ILjava/lang/String;Landroid/app/AppOpsManager$OnOpChangedListener;)V

    new-instance v11, Lcom/android/server/LocationManagerService$3;

    invoke-direct {v11, p0}, Lcom/android/server/LocationManagerService$3;-><init>(Lcom/android/server/LocationManagerService;)V
    ...
    iput-object v0, p0, Lcom/android/server/LocationManagerService;->telManager:Landroid/telephony/TelephonyManager;

    iget-object v0, p0, Lcom/android/server/LocationManagerService;->telManager:Landroid/telephony/TelephonyManager;

    new-instance v1, Lcom/android/server/LocationManagerService$MSiPhoneStateListener;

    const/4 v2, 0x0

    invoke-direct {v1, p0, v2}, Lcom/android/server/LocationManagerService$MSiPhoneStateListener;-><init>(Lcom/android/server/LocationManagerService;Lcom/android/server/LocationManagerService$1;)V
    ...
    invoke-direct {v1, p0, v2}, Lcom/android/server/LocationManagerService$NetworkStateReceiver;-><init>(Lcom/android/server/LocationManagerService;Lcom/android/server/LocationManagerService$1;)V
    ...
    invoke-direct {v2, p0, v4}, Lcom/android/server/LocationManagerService$4;-><init>(Lcom/android/server/LocationManagerService;Landroid/os/Handler;)V

    const/4 v4, -0x1

    invoke-virtual {v0, v1, v9, v2, v4}, Landroid/content/ContentResolver;->registerContentObserver(Landroid/net/Uri;ZLandroid/database/ContentObserver;I)V
    ...
    new-instance v5, Lcom/android/server/LocationManagerService$5;

    invoke-direct {v5, p0}, Lcom/android/server/LocationManagerService$5;-><init>(Lcom/android/server/LocationManagerService;)V
    ...
    .end local v3    # "networkStateFilter":Landroid/content/IntentFilter;
