...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string v3, "handleMessage RuntimeException: "
    ...
    invoke-virtual {v8}, Lcom/android/internal/telephony/uicc/AdnRecord;->getErrorNumber()I

    move-result v11

    .local v11, "errorNum":I
    const/4 v1, -0x1
    ...
    const-string v2, "data is null and DIAL_STRING_TOO_LONG"

    invoke-static {v1, v2}, Landroid/telephony/Rlog;->d(Ljava/lang/String;Ljava/lang/String;)I

    new-instance v1, Ljava/lang/RuntimeException;

    const-string v2, "NUMBER_STRING_TOO_LONG"
    ...
    const-string v2, "data is null and TEXT_STRING_TOO_LONG"

    invoke-static {v1, v2}, Landroid/telephony/Rlog;->d(Ljava/lang/String;Ljava/lang/String;)I

    new-instance v1, Ljava/lang/RuntimeException;

    const-string v2, "TEXT_STRING_TOO_LONG"
    ...
    invoke-virtual {v1, v2, v0, v3}, Lcom/android/internal/telephony/uicc/IccFileHandler;->loadEFLinearFixedAll(ILjava/lang/String;Landroid/os/Message;)V
    ...
    .end local v15    # "i":I
    .end local v18    # "s":I
    .restart local v12    # "exc":Ljava/lang/RuntimeException;
    :cond_13
    move-object/from16 v0, p0
