...
.method private updateAdnBySearchOnEf(ZILcom/android/internal/telephony/uicc/AdnRecord;Lcom/android/internal/telephony/uicc/AdnRecord;Ljava/lang/String;Landroid/os/Message;)I
    ...
    .line 391
    .local v25, "oldAdnList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/internal/telephony/uicc/AdnRecord;>;"
    const/16 v3, 0x4f30
    ...
    iget-boolean v3, v0, Lcom/android/internal/telephony/uicc/AdnRecordCache;->isPbrNotInLocal:Z
    ...
    iget-object v12, v0, Lcom/android/internal/telephony/uicc/AdnRecordCache;->mUsimGlobalPhoneBookManager:Lcom/android/internal/telephony/gsm/UsimPhoneBookManager;

    .line 399
    .local v12, "anotherPhoneBookManager":Lcom/android/internal/telephony/gsm/UsimPhoneBookManager;
    :goto_2
    invoke-virtual {v12}, Lcom/android/internal/telephony/gsm/UsimPhoneBookManager;->loadEfFilesFromUsim()Ljava/util/ArrayList;

    .line 414
    .end local v12    # "anotherPhoneBookManager":Lcom/android/internal/telephony/gsm/UsimPhoneBookManager;
    :cond_7
    :goto_3
    if-nez v25, :cond_a
    ...
    iget-object v12, v0, Lcom/android/internal/telephony/uicc/AdnRecordCache;->mUsimLocalPhoneBookManager:Lcom/android/internal/telephony/gsm/UsimPhoneBookManager;
    ...
    .line 422
    .local v17, "emailNum":I
    const/16 v21, 0x0

    .line 423
    .local v21, "isEmailFull":Z
    const/16 v20, 0x0

    .line 424
    .local v20, "isAnrFull":Z
    invoke-virtual/range {v25 .. v25}, Ljava/util/ArrayList;->iterator()Ljava/util/Iterator;

    move-result-object v22

    .local v22, "it":Ljava/util/Iterator;, "Ljava/util/Iterator<Lcom/android/internal/telephony/uicc/AdnRecord;>;"
    :goto_4
    ...
    .line 426
    .local v23, "nextAdnRecord":Lcom/android/internal/telephony/uicc/AdnRecord;
    const/16 v21, 0x0
    ...
    .line 460
    .end local v23    # "nextAdnRecord":Lcom/android/internal/telephony/uicc/AdnRecord;
    :cond_e
    const/4 v3, -0x1
    ...
    .line 457
    .restart local v23    # "nextAdnRecord":Lcom/android/internal/telephony/uicc/AdnRecord;
    :cond_f
    ...
    .line 483
    invoke-virtual/range {v18 .. v18}, Lcom/android/internal/telephony/uicc/AdnRecord;->getAdditionalNumbers()[Ljava/lang/String;
...
.method public declared-synchronized updateUsimAdnByIndex(ILcom/android/internal/telephony/uicc/AdnRecord;ILjava/lang/String;Landroid/os/Message;)V
    ...
    iget-boolean v3, v0, Lcom/android/internal/telephony/uicc/AdnRecordCache;->mUseLocalPb:Z

    if-eqz v3, :cond_8

    move-object/from16 v0, p0

    iget-object v11, v0, Lcom/android/internal/telephony/uicc/AdnRecordCache;->mUsimGlobalPhoneBookManager:Lcom/android/internal/telephony/gsm/UsimPhoneBookManager;

    .line 874
    .local v11, "anotherPhoneBookManager":Lcom/android/internal/telephony/gsm/UsimPhoneBookManager;
    :goto_2
    invoke-virtual {v11}, Lcom/android/internal/telephony/gsm/UsimPhoneBookManager;->loadEfFilesFromUsim()Ljava/util/ArrayList;
    :try_end_3
    .catch Ljava/lang/NullPointerException; {:try_start_3 .. :try_end_3} :catch_0
    .catchall {:try_start_3 .. :try_end_3} :catchall_0

    .line 888
    .end local v11    # "anotherPhoneBookManager":Lcom/android/internal/telephony/gsm/UsimPhoneBookManager;
    :cond_7
    :goto_3
    if-nez v17, :cond_a
    ...
    iget-object v11, v0, Lcom/android/internal/telephony/uicc/AdnRecordCache;->mUsimLocalPhoneBookManager:Lcom/android/internal/telephony/gsm/UsimPhoneBookManager;
