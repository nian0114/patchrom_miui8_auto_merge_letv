...
.method private isOperatorConsideredNonRoaming(Landroid/telephony/ServiceState;Landroid/content/res/Resources;)Z
    .locals 9
    .param p1, "s"    # Landroid/telephony/ServiceState;
...
.method private isOperatorConsideredRoaming(Landroid/telephony/ServiceState;Landroid/content/res/Resources;)Z
    .locals 9
    .param p1, "s"    # Landroid/telephony/ServiceState;
    .param p2, "res"    # Landroid/content/res/Resources;
...
.method private onRestrictedStateChanged(Landroid/os/AsyncResult;)V
    ...
    const-string v6, "onRestrictedStateChanged: state =  "
...
.method protected updateRoamingState()V
    ...
    invoke-direct {p0, v7, v3}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->isOperatorConsideredRoaming(Landroid/telephony/ServiceState;Landroid/content/res/Resources;)Z
    ...
    invoke-direct {p0, v7}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->isSameNamedOperators(Landroid/telephony/ServiceState;)Z
    ...
    invoke-direct {p0, v7, v3}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->isOperatorConsideredNonRoaming(Landroid/telephony/ServiceState;Landroid/content/res/Resources;)Z
    ...
    const-string v8, "updateRoamingState roaming = "
    ...
    invoke-virtual {v7, v4}, Landroid/telephony/ServiceState;->setDataRoamingFromRegistration(Z)V
    ...
    invoke-virtual {v7}, Lcom/android/internal/telephony/gsm/GSMPhone;->getSubId()I

    move-result v7

    invoke-interface {v1, v7}, Lcom/android/internal/telephony/ICarrierConfigLoader;->getConfigForSubId(I)Landroid/os/PersistableBundle;
    ...
    const-string v7, "updateRoamingState: carrier config override always on home network"
    ...
    invoke-virtual {v7, v4}, Landroid/telephony/ServiceState;->setVoiceRoaming(Z)V

    iget-object v7, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->mNewSS:Landroid/telephony/ServiceState;

    invoke-virtual {v7, v4}, Landroid/telephony/ServiceState;->setDataRoaming(Z)V
    ...
    invoke-virtual {p0, v0, v7}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->isNonRoamingInGsmNetwork(Landroid/os/BaseBundle;Ljava/lang/String;)Z
    ...
    const-string v8, "updateRoamingState: carrier config override set non roaming:"

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    iget-object v8, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->mNewSS:Landroid/telephony/ServiceState;
    ...
    invoke-virtual {p0, v0, v7}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->isRoamingInGsmNetwork(Landroid/os/BaseBundle;Ljava/lang/String;)Z
    ...
    const-string v8, "updateRoamingState: carrier config override set roaming:"
    ...
    const-string v7, "updateRoamingState: unable to access carrier config service"
    ...
    :cond_8
    const-string v7, "updateRoamingState: no carrier config service available"
...
.method protected updateSpnDisplay()V
    ...
    invoke-static {v1, v2}, Lcom/android/internal/telephony/uicc/SpnOverride;->getSpnByEfSpn(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_5
    invoke-static {v2, v1}, Lcom/android/internal/telephony/uicc/SpnOverride;->lookupOperatorName(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v2, "updateSpnDisplay: lookupOperatorName --- Spn = "
    ...
    const-string v2, "updateSpnDisplay: getServiceProviderName --- Spn = "
    ...
    const-string v2, "updateSpnDisplay: 1 -- rule = "
    ...
    const-string v1, "updateSpnDisplay: In Wi-Fi Calling mode show SPN+WiFi "
    ...
    const-string v2, "updateSpnDisplay: 2 -- showSpn = "
    ...
    const-string v2, "updateSpnDisplay: mSubId = "
    ...
    :cond_6
    const-string v1, "updateSpnDisplay: sendStickyBroadcastAsUser and setPlmnSpn"
    ...
    :goto_a
    invoke-static {v2, v1}, Lcom/android/internal/telephony/uicc/SpnOverride;->getSpnByEfSpn(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1, v2}, Lcom/android/internal/telephony/uicc/SpnOverride;->lookupOperatorName(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v2, "updateSpnDisplay: lookupOperatorName --- plmn = "
    ...
    const-string v2, "updateSpnDisplay: getOperatorAlphaLong --- plmn = "
    ...
    :cond_18
    const-string v1, "updateSpnDisplay: airplane mode or spn equals plmn, do not show spn "
