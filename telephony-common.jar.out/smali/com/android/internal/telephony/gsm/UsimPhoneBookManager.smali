...
.method public constructor <init>(Lcom/android/internal/telephony/uicc/IccFileHandler;Lcom/android/internal/telephony/uicc/AdnRecordCache;)V
    ...
    .line 114
    iput v1, p0, Lcom/android/internal/telephony/gsm/UsimPhoneBookManager;->mErrCause:I
...
.method private buildAnrData(IILjava/lang/String;)[B
    ...
    const-string v9, "[buildAnrData] length is: "
    ...
    iput v8, p0, Lcom/android/internal/telephony/gsm/UsimPhoneBookManager;->mErrCause:I
    ...
    const-string v9, "buildAnrData: data is"
...
.method private buildEmailData(IILjava/lang/String;)[B
    ...
    const-string v7, "[buildEmailData] the length is: "
    ...
    iput v6, p0, Lcom/android/internal/telephony/gsm/UsimPhoneBookManager;->mErrCause:I
...
.method private getAnrRecNumber(IILjava/lang/String;)I
    ...
    const-string v9, "getAnrRecNumber: recnum from iap is :"
    ...
    const-string v9, "getAnrRecNumber: anr record size is :"
    ...
    const-string v9, "getAnrRecNumber: Empty anr record. Anr record num is :"
    ...
    .restart local v7    # "recsSize":I
    :cond_5
    const-string v8, "getAnrRecNumber: no anr record index found"
...
.method private getEmailRecNumber(IILjava/lang/String;)I
    ...
    const-string v9, "getEmailRecNumber recsSize is: "
    ...
    const-string v9, "getEmailRecNumber: Got empty record.Email record num is :"
    ...
    .restart local v7    # "recsSize":I
    :cond_5
    const-string v8, "getEmailRecNumber: no email record index found"
...
.method private readAnrFileAndWait(I)V
    ...
    .line 331
    .local v0, "anrEfids":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/Integer;>;"
    ...
    const-string v8, "mPbrFile or mAnrFileIds is empty return from readAnrFileAndWait"
    ...
    .line 327
    .end local v0    # "anrEfids":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/Integer;>;"
    .end local v2    # "efid":I
    ...
    const-string v8, "NullPointerException catched when get mAnrFileIds"
    ...
    .restart local v0    # "anrEfids":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/Integer;>;"
    ...
    const-string v8, "getValidRecordNums is null in readAnrFileAndWait"
    ...
    invoke-virtual {v7, v2, v8, v9, v10}, Lcom/android/internal/telephony/uicc/IccFileHandler;->loadEFLinearFixedPart(ILjava/lang/String;Ljava/util/ArrayList;Landroid/os/Message;)V
...
.method private readEmailFileAndWait(I)V
    ...
    const-string v6, "mPbrFile is NULL, exiting from readAdnFileAndWait"
    ...
    const-string v6, "getValidRecordNums is null in readEmailFileAndWait"
...
.method private readIapFileAndWait(II)V
    ...
    const-string v2, "getValidRecordNums is null in readIapFileAndWait"
...
.method public getErrCause()I
    .locals 1

    .prologue
    .line 972
    iget v0, p0, Lcom/android/internal/telephony/gsm/UsimPhoneBookManager;->mErrCause:I
