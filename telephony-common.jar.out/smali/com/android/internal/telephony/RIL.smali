...
.field private static final OEMHOOK_EVT_HOOK_PINPUK_RETURYCOUNT:I = 0x80063
...
.method private broadcastMCCChangedIntent([B)V
    .locals 3
    .param p1, "data"    # [B
    ...
    const-string v1, "android.intent.action.ril_sys_info_mcc_changed"
    ...
    const-string v2, "broadcastMCCChangedIntent "
    ...
    .line 2971
    const-string v1, "Broadcasting intent android.intent.action.ril_sys_info_mcc_changed"
...
.method private check_sys_info_mcc_change(Ljava/lang/Object;)V
    .locals 13
    ...
    .line 2978
    .local v1, "OEMIdentifier":Ljava/lang/String;
    const/4 v0, 0x4

    .line 2979
    .local v0, "INT_SIZE":I
    const-string v11, "QOEMHOOK"
    ...
    .line 2981
    .local v2, "QCRILHOOK_BASE":I
    const v3, 0x8042e

    .line 2982
    .local v3, "QCRILHOOK_UNSOL_SYSINFO_MCC_CHANGED":I
    const/4 v9, 0x0

    .local v9, "response_id":I
    const/4 v10, 0x0

    .line 2984
    .local v10, "response_size":I
    check-cast p1, [B
    ...
    .line 2985
    .local v5, "oemHookResponse":Ljava/nio/ByteBuffer;
    ...
    const-string v12, "RIL_UNSOL_OEM_HOOK_RAW data size is "
    ...
    const-string v12, " assume external OEM message, not QOEMHOOK"
    ...
    .line 3001
    .local v7, "oem_id_str":Ljava/lang/String;
    new-instance v11, Ljava/lang/StringBuilder;

    invoke-direct {v11}, Ljava/lang/StringBuilder;-><init>()V

    const-string v12, "Oem ID in RIL_UNSOL_OEM_HOOK_RAW is "
    ...
    .line 3004
    const-string v11, "external OEM message, not QOEMHOOK"
    ...
    .line 3019
    .local v8, "response_data":[B
    const/4 v11, 0x0

    invoke-virtual {v5, v8, v11, v10}, Ljava/nio/ByteBuffer;->get([BII)Ljava/nio/ByteBuffer;
    ...
    .line 3025
    invoke-direct {p0, v8}, Lcom/android/internal/telephony/RIL;->broadcastMCCChangedIntent([B)V
...
.method private processUnsolicited(Landroid/os/Parcel;)V
    ...
    invoke-direct {v0, v1}, Lcom/android/internal/telephony/RIL;->check_sys_info_mcc_change(Ljava/lang/Object;)V
...
.method static requestToString(I)Ljava/lang/String;
    ...
    .line 4335
    :pswitch_20
    const-string v0, "SIM_GET_SELECT_RESPONSE"
...
.method private responseCallList(Landroid/os/Parcel;)Ljava/lang/Object;
    ...
    iput v8, v0, Lcom/android/internal/telephony/DriverCall;->codec:I
...
.method public getPukPinRetryCount(ILandroid/os/Message;)V
    .locals 5
    .param p1, "slotId"    # I
    .param p2, "response"    # Landroid/os/Message;
    ...
    const-string v3, "getPukPinRetryCount: slotId: "
    ...
    invoke-direct {p0, v1, v4, v0, p2}, Lcom/android/internal/telephony/RIL;->sendOemRilRequestRaw(II[BLandroid/os/Message;)V
...
.method public iccGetSelectResponse(Landroid/os/Message;)V
    .locals 3
    .param p1, "result"    # Landroid/os/Message;
    ...
    const-string v2, "> iccGetSelectResponse: "
