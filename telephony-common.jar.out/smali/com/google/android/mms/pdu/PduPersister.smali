...
.method private persistForBackupRestore(Lcom/google/android/mms/pdu/GenericPdu;Landroid/net/Uri;Ljava/util/HashMap;)Landroid/net/Uri;
    ...
    .local v47, "set":Ljava/util/Set;, "Ljava/util/Set<Ljava/util/Map$Entry<Ljava/lang/Integer;Ljava/lang/String;>;>;"
    ...
    .end local v47    # "set":Ljava/util/Set;, "Ljava/util/Set<Ljava/util/Map$Entry<Ljava/lang/Integer;Ljava/lang/String;>;>;"
    :catch_0
    move-exception v18
    ...
    .restart local v47    # "set":Ljava/util/Set;, "Ljava/util/Set<Ljava/util/Map$Entry<Ljava/lang/Integer;Ljava/lang/String;>;>;"
    :cond_5
    ...
    .local v60, "v":Lcom/google/android/mms/pdu/EncodedStringValue;
    if-eqz v60, :cond_f
    ...
    aput-object v60, v13, v4

    .end local v60    # "v":Lcom/google/android/mms/pdu/EncodedStringValue;
    :cond_f
    :goto_8
    ...
    .local v53, "threadType":I
    const/16 v51, 0x0

    .local v51, "syncCall":Z
    if-eqz p3, :cond_12

    const-string v4, "thread_extend_type"
    ...
    .local v46, "recipients":Ljava/util/HashSet;, "Ljava/util/HashSet<Ljava/lang/String;>;"
    ...
    aget-object v60, v12, v28

    .restart local v60    # "v":Lcom/google/android/mms/pdu/EncodedStringValue;
    if-eqz v60, :cond_14

    invoke-virtual/range {v60 .. v60}, Lcom/google/android/mms/pdu/EncodedStringValue;->getString()Ljava/lang/String;
    ...
    :cond_16
    invoke-virtual/range {v46 .. v46}, Ljava/util/HashSet;->isEmpty()Z
    ...
    .local v38, "pendingValues":Landroid/content/ContentValues;
    ...
    .end local v21    # "err_type":I
    .end local v38    # "pendingValues":Landroid/content/ContentValues;
    :cond_1b
    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J
    ...
    sub-long v44, v58, v56

    .local v44, "persistPdu_t":J
    const-string v4, "MMSLog"
    ...
    .end local v10    # "addrType":I
    .end local v12    # "arr$":[I
    .end local v32    # "locked":I
    .end local v44    # "persistPdu_t":J
    .end local v50    # "sub_id":I
    .end local v58    # "time_2":J
    .restart local v15    # "backupRestore":Ljava/lang/String;
    ...
    .restart local v32    # "locked":I
    .restart local v50    # "sub_id":I
    :cond_1e
    move-object/from16 v0, p0
    ...
    .restart local v12    # "arr$":[I
    .restart local v44    # "persistPdu_t":J
    .restart local v58    # "time_2":J
    :cond_20
    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J
    ...
    .end local v40    # "persistAddress_t":J
    .end local v44    # "persistPdu_t":J
    .end local v46    # "recipients":Ljava/util/HashSet;, "Ljava/util/HashSet<Ljava/lang/String;>;"
    .end local v47    # "set":Ljava/util/Set;, "Ljava/util/Set<Ljava/util/Map$Entry<Ljava/lang/Integer;Ljava/lang/String;>;>;"
    .end local v50    # "sub_id":I
    .end local v51    # "syncCall":Z
    .end local v53    # "threadType":I
    .end local v56    # "time_1":J
    .end local v58    # "time_2":J
...
.method public persist(Lcom/google/android/mms/pdu/GenericPdu;Landroid/net/Uri;ZZLjava/util/HashMap;)Landroid/net/Uri;
    ...
    .end local v32    # "existingUri":Z
    :cond_1
    const/16 v32, 0x0

    goto :goto_1

    .restart local v32    # "existingUri":Z
    :cond_2
    ...
    .local v31, "encodedString":Lcom/google/android/mms/pdu/EncodedStringValue;
    if-eqz v31, :cond_4
    ...
    .local v24, "charsetColumn":Ljava/lang/String;
    ...
    invoke-virtual/range {v31 .. v31}, Lcom/google/android/mms/pdu/EncodedStringValue;->getCharacterSet()I
    ...
    .end local v24    # "charsetColumn":Ljava/lang/String;
    .end local v30    # "e":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/Integer;Ljava/lang/String;>;"
    .end local v31    # "encodedString":Lcom/google/android/mms/pdu/EncodedStringValue;
    .end local v33    # "field":I
    ...
    .local v21, "array":[Lcom/google/android/mms/pdu/EncodedStringValue;
    const/16 v6, 0x89
    ...
    .end local v21    # "array":[Lcom/google/android/mms/pdu/EncodedStringValue;
    :cond_e
    ...
    .local v51, "spamType":I
    invoke-virtual/range {v49 .. v49}, Ljava/util/HashSet;->size()I
    ...
    invoke-virtual/range {v49 .. v49}, Ljava/util/HashSet;->iterator()Ljava/util/Iterator;
    ...
    const-string v8, "include_black_list_mms"
    ...
    invoke-interface/range {v25 .. v25}, Landroid/database/Cursor;->getExtras()Landroid/os/Bundle;
    ...
    .local v53, "textOnly":Z
    const/16 v43, 0x0

    .local v43, "messageSize":I
    move-object/from16 v0, p1
    ...
    invoke-virtual/range {v47 .. v47}, Lcom/google/android/mms/pdu/PduPart;->getDataLength()I
    ...
    invoke-static/range {v47 .. v47}, Lcom/google/android/mms/pdu/PduPersister;->getPartContentType(Lcom/google/android/mms/pdu/PduPart;)Ljava/lang/String;
    ...
    check-cast v21, [Lcom/google/android/mms/pdu/EncodedStringValue;

    .restart local v21    # "array":[Lcom/google/android/mms/pdu/EncodedStringValue;
    if-eqz v21, :cond_1c
